...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	3f250513          	addi	a0,a0,1010 # 6430 <tournament_release+0xa4>
      ...
      74:	8082                	ret
{
      ...
      84:	3d050513          	addi	a0,a0,976 # 6450 <tournament_release+0xc4>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	3c050513          	addi	a0,a0,960 # 6468 <tournament_release+0xdc>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	3c250513          	addi	a0,a0,962 # 6488 <tournament_release+0xfc>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	38a50513          	addi	a0,a0,906 # 6470 <tournament_release+0xe4>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	39650513          	addi	a0,a0,918 # 6498 <tournament_release+0x10c>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	39450513          	addi	a0,a0,916 # 64c0 <tournament_release+0x134>
     134:	00006097          	auipc	ra,0x6
     138:	ae2080e7          	jalr	-1310(ra) # 5c16 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	38050513          	addi	a0,a0,896 # 64c0 <tournament_release+0x134>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	37c58593          	addi	a1,a1,892 # 64d0 <tournament_release+0x144>
     15c:	00006097          	auipc	ra,0x6
     160:	a8a080e7          	jalr	-1398(ra) # 5be6 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	35850513          	addi	a0,a0,856 # 64c0 <tournament_release+0x134>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	35c58593          	addi	a1,a1,860 # 64d8 <tournament_release+0x14c>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	32c50513          	addi	a0,a0,812 # 64c0 <tournament_release+0x134>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	31650513          	addi	a0,a0,790 # 64e0 <tournament_release+0x154>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	28c50513          	addi	a0,a0,652 # 6508 <tournament_release+0x17c>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	278a8a93          	addi	s5,s5,632 # 6508 <tournament_release+0x17c>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	20650513          	addi	a0,a0,518 # 6518 <tournament_release+0x18c>
     ...
     33a:	20250513          	addi	a0,a0,514 # 6538 <tournament_release+0x1ac>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     364:	1f050513          	addi	a0,a0,496 # 6550 <tournament_release+0x1c4>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     378:	1dc98993          	addi	s3,s3,476 # 6550 <tournament_release+0x1c4>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c4:	19050513          	addi	a0,a0,400 # 6550 <tournament_release+0x1c4>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3dc:	10058593          	addi	a1,a1,256 # 64d8 <tournament_release+0x14c>
    ...
    printf("write failed\n");
     ...
     3f2:	18250513          	addi	a0,a0,386 # 6570 <tournament_release+0x1e4>
    ...
    exit(1);
     ...
     40c:	15050513          	addi	a0,a0,336 # 6558 <tournament_release+0x1cc>
    ...
    printf("open junk failed\n");
     ...
     426:	13650513          	addi	a0,a0,310 # 6558 <tournament_release+0x1cc>
  ...
  unlink("junk");
     ...
     44a:	10a50513          	addi	a0,a0,266 # 6550 <tournament_release+0x1c4>
...
0000000000000530 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     556:	02ea0a13          	addi	s4,s4,46 # 6580 <tournament_release+0x1f4>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     602:	f8a50513          	addi	a0,a0,-118 # 6588 <tournament_release+0x1fc>
     ...
     620:	f8450513          	addi	a0,a0,-124 # 65a0 <tournament_release+0x214>
     ...
     63e:	f9650513          	addi	a0,a0,-106 # 65d0 <tournament_release+0x244>
     ...
     658:	fac50513          	addi	a0,a0,-84 # 6600 <tournament_release+0x274>
     ...
     676:	f9e50513          	addi	a0,a0,-98 # 6610 <tournament_release+0x284>
...
000000000000068c <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b4:	f90a0a13          	addi	s4,s4,-112 # 6640 <tournament_release+0x2b4>
    n = write(fds[1], "x", 1);
     6b8:	00006a97          	auipc	s5,0x6
     6bc:	e20a8a93          	addi	s5,s5,-480 # 64d8 <tournament_release+0x14c>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     762:	eea50513          	addi	a0,a0,-278 # 6648 <tournament_release+0x2bc>
     ...
     780:	ee450513          	addi	a0,a0,-284 # 6660 <tournament_release+0x2d4>
     ...
     79a:	e6a50513          	addi	a0,a0,-406 # 6600 <tournament_release+0x274>
     ...
     7b4:	ee050513          	addi	a0,a0,-288 # 6690 <tournament_release+0x304>
     ...
     7d2:	eda50513          	addi	a0,a0,-294 # 66a8 <tournament_release+0x31c>
...
00000000000007e8 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     828:	cac58593          	addi	a1,a1,-852 # 64d0 <tournament_release+0x144>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     844:	c8050513          	addi	a0,a0,-896 # 64c0 <tournament_release+0x134>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     870:	c5450513          	addi	a0,a0,-940 # 64c0 <tournament_release+0x134>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     884:	c4050513          	addi	a0,a0,-960 # 64c0 <tournament_release+0x134>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c2:	e7a58593          	addi	a1,a1,-390 # 6738 <tournament_release+0x3ac>
     8c6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     904:	bc050513          	addi	a0,a0,-1088 # 64c0 <tournament_release+0x134>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     948:	d9450513          	addi	a0,a0,-620 # 66d8 <tournament_release+0x34c>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     964:	d9850513          	addi	a0,a0,-616 # 66f8 <tournament_release+0x36c>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     978:	d9450513          	addi	a0,a0,-620 # 6708 <tournament_release+0x37c>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     994:	d9850513          	addi	a0,a0,-616 # 6728 <tournament_release+0x39c>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a8:	d6450513          	addi	a0,a0,-668 # 6708 <tournament_release+0x37c>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c6:	d7e50513          	addi	a0,a0,-642 # 6740 <tournament_release+0x3b4>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e4:	d8050513          	addi	a0,a0,-640 # 6760 <tournament_release+0x3d4>
...
00000000000009fa <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a18:	d6c50513          	addi	a0,a0,-660 # 6780 <tournament_release+0x3f4>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a30:	d7c98993          	addi	s3,s3,-644 # 67a8 <tournament_release+0x41c>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a34:	00006a97          	auipc	s5,0x6
     a38:	daca8a93          	addi	s5,s5,-596 # 67e0 <tournament_release+0x454>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7e:	d0650513          	addi	a0,a0,-762 # 6780 <tournament_release+0x3f4>
  ...
  if(unlink("small") < 0){
     ...
     aba:	cca50513          	addi	a0,a0,-822 # 6780 <tournament_release+0x3f4>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae4:	ca850513          	addi	a0,a0,-856 # 6788 <tournament_release+0x3fc>
    ...
    exit(1);
     ...
     b02:	cba50513          	addi	a0,a0,-838 # 67b8 <tournament_release+0x42c>
     ...
     b20:	cd450513          	addi	a0,a0,-812 # 67f0 <tournament_release+0x464>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3c:	ce050513          	addi	a0,a0,-800 # 6818 <tournament_release+0x48c>
    ...
    printf("%s: read failed\n", s);
     ...
     b58:	ce450513          	addi	a0,a0,-796 # 6838 <tournament_release+0x4ac>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b74:	ce050513          	addi	a0,a0,-800 # 6850 <tournament_release+0x4c4>
...
0000000000000b8a <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba6:	cce50513          	addi	a0,a0,-818 # 6870 <tournament_release+0x4e4>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf8:	c7c50513          	addi	a0,a0,-900 # 6870 <tournament_release+0x4e4>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c40:	c3c50513          	addi	a0,a0,-964 # 6878 <tournament_release+0x4ec>
    ...
    exit(1);
     ...
     c5e:	c3e50513          	addi	a0,a0,-962 # 6898 <tournament_release+0x50c>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c7a:	c4a50513          	addi	a0,a0,-950 # 68c0 <tournament_release+0x534>
  ...
  if(unlink("big") < 0){
     ...
     ca6:	bce50513          	addi	a0,a0,-1074 # 6870 <tournament_release+0x4e4>
     ...
     cd2:	c1250513          	addi	a0,a0,-1006 # 68e0 <tournament_release+0x554>
     ...
     cf0:	c1c50513          	addi	a0,a0,-996 # 6908 <tournament_release+0x57c>
     ...
     d0e:	c1650513          	addi	a0,a0,-1002 # 6920 <tournament_release+0x594>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d2a:	c2250513          	addi	a0,a0,-990 # 6948 <tournament_release+0x5bc>
...
0000000000000d40 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d58:	c0c50513          	addi	a0,a0,-1012 # 6960 <tournament_release+0x5d4>
  ...
  write(fd, "hello", SZ);
     ...
     d70:	c2458593          	addi	a1,a1,-988 # 6990 <tournament_release+0x604>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8c:	bd850513          	addi	a0,a0,-1064 # 6960 <tournament_release+0x5d4>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da2:	bc250513          	addi	a0,a0,-1086 # 6960 <tournament_release+0x5d4>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db8:	bac50513          	addi	a0,a0,-1108 # 6960 <tournament_release+0x5d4>
  ...
  write(fd1, "yyy", 3);
     ...
     dcc:	c1058593          	addi	a1,a1,-1008 # 69d8 <tournament_release+0x64c>
  ...
  unlink("unlinkread");
     ...
     e34:	b3050513          	addi	a0,a0,-1232 # 6960 <tournament_release+0x5d4>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e54:	b2050513          	addi	a0,a0,-1248 # 6970 <tournament_release+0x5e4>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e70:	b2c50513          	addi	a0,a0,-1236 # 6998 <tournament_release+0x60c>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8c:	b3050513          	addi	a0,a0,-1232 # 69b8 <tournament_release+0x62c>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea8:	b3c50513          	addi	a0,a0,-1220 # 69e0 <tournament_release+0x654>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec4:	b4050513          	addi	a0,a0,-1216 # 6a00 <tournament_release+0x674>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ee0:	b4450513          	addi	a0,a0,-1212 # 6a20 <tournament_release+0x694>
...
0000000000000ef6 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f44:	a5058593          	addi	a1,a1,-1456 # 6990 <tournament_release+0x604>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f64:	ae858593          	addi	a1,a1,-1304 # 6a48 <tournament_release+0x6bc>
     f68:	00006517          	auipc	a0,0x6
     f6c:	ad850513          	addi	a0,a0,-1320 # 6a40 <tournament_release+0x6b4>
  ...
  unlink("lf1");
     ...
     f80:	ac450513          	addi	a0,a0,-1340 # 6a40 <tournament_release+0x6b4>
     f84:	00005097          	auipc	ra,0x5
     f88:	c92080e7          	jalr	-878(ra) # 5c16 <unlink>
  if(open("lf1", 0) >= 0){
     f8c:	4581                	li	a1,0
     f8e:	00006517          	auipc	a0,0x6
     f92:	ab250513          	addi	a0,a0,-1358 # 6a40 <tournament_release+0x6b4>
  ...
  fd = open("lf2", 0);
     ...
     fa8:	aa450513          	addi	a0,a0,-1372 # 6a48 <tournament_release+0x6bc>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fe0:	a6c58593          	addi	a1,a1,-1428 # 6a48 <tournament_release+0x6bc>
     fe4:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff6:	a5650513          	addi	a0,a0,-1450 # 6a48 <tournament_release+0x6bc>
     ffa:	00005097          	auipc	ra,0x5
     ffe:	c1c080e7          	jalr	-996(ra) # 5c16 <unlink>
  if(link("lf2", "lf1") >= 0){
    1002:	00006597          	auipc	a1,0x6
    1006:	a3e58593          	addi	a1,a1,-1474 # 6a40 <tournament_release+0x6b4>
    100a:	00006517          	auipc	a0,0x6
    100e:	a3e50513          	addi	a0,a0,-1474 # 6a48 <tournament_release+0x6bc>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1022:	a2258593          	addi	a1,a1,-1502 # 6a40 <tournament_release+0x6b4>
    1026:	00006517          	auipc	a0,0x6
    102a:	b2a50513          	addi	a0,a0,-1238 # 6b50 <tournament_release+0x7c4>
    ...
    104c:	a0850513          	addi	a0,a0,-1528 # 6a50 <tournament_release+0x6c4>
    ...
    1068:	a0450513          	addi	a0,a0,-1532 # 6a68 <tournament_release+0x6dc>
    ...
    1084:	a0050513          	addi	a0,a0,-1536 # 6a80 <tournament_release+0x6f4>
    ...
    10a0:	a0450513          	addi	a0,a0,-1532 # 6aa0 <tournament_release+0x714>
    ...
    10bc:	a1850513          	addi	a0,a0,-1512 # 6ad0 <tournament_release+0x744>
    ...
    10d8:	a1450513          	addi	a0,a0,-1516 # 6ae8 <tournament_release+0x75c>
    ...
    10f4:	a1050513          	addi	a0,a0,-1520 # 6b00 <tournament_release+0x774>
    ...
    1110:	a1c50513          	addi	a0,a0,-1508 # 6b28 <tournament_release+0x79c>
    ...
    112c:	a3050513          	addi	a0,a0,-1488 # 6b58 <tournament_release+0x7cc>
...
0000000000001142 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115e:	a1e98993          	addi	s3,s3,-1506 # 6b78 <tournament_release+0x7ec>
    1162:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    119a:	9f250513          	addi	a0,a0,-1550 # 6b88 <tournament_release+0x7fc>
...
00000000000011b0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    11ca:	9e250513          	addi	a0,a0,-1566 # 6ba8 <tournament_release+0x81c>
    11ce:	00005097          	auipc	ra,0x5
    11d2:	a48080e7          	jalr	-1464(ra) # 5c16 <unlink>
  fd = open("bd", O_CREATE);
    11d6:	20000593          	li	a1,512
    11da:	00006517          	auipc	a0,0x6
    11de:	9ce50513          	addi	a0,a0,-1586 # 6ba8 <tournament_release+0x81c>
  ...
  for(i = 0; i < N; i++){
    ...
    1200:	9aca0a13          	addi	s4,s4,-1620 # 6ba8 <tournament_release+0x81c>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1252:	95a50513          	addi	a0,a0,-1702 # 6ba8 <tournament_release+0x81c>
  ...
  for(i = 0; i < N; i++){
    ...
    12c2:	8f250513          	addi	a0,a0,-1806 # 6bb0 <tournament_release+0x824>
    ...
    12e2:	8f250513          	addi	a0,a0,-1806 # 6bd0 <tournament_release+0x844>
    ...
    12fe:	8f650513          	addi	a0,a0,-1802 # 6bf0 <tournament_release+0x864>
...
000000000000134c <badarg>:
{
    ...
    136a:	10298993          	addi	s3,s3,258 # 6468 <tournament_release+0xdc>
    argv[0] = (char*)0xffffffff;
...
0000000000001392 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f4:	a5878793          	addi	a5,a5,-1448 # 7e48 <tournament_release+0x1abc>
  ...
  if(pid == 0){
    ...
    1450:	41c78793          	addi	a5,a5,1052 # 8868 <tournament_release+0x24dc>
    ...
    1474:	ff850513          	addi	a0,a0,-8 # 6468 <tournament_release+0xdc>
    ...
    148c:	81050513          	addi	a0,a0,-2032 # 6c98 <tournament_release+0x90c>
    ...
    14ac:	76850513          	addi	a0,a0,1896 # 6c10 <tournament_release+0x884>
    ...
    14cc:	76850513          	addi	a0,a0,1896 # 6c30 <tournament_release+0x8a4>
    ...
    14ee:	76650513          	addi	a0,a0,1894 # 6c50 <tournament_release+0x8c4>
    ...
    150e:	76e50513          	addi	a0,a0,1902 # 6c78 <tournament_release+0x8ec>
    ...
    1528:	bd450513          	addi	a0,a0,-1068 # 70f8 <tournament_release+0xd6c>
  ...
  if(st != 747){
    ...
    1572:	75250513          	addi	a0,a0,1874 # 6cc0 <tournament_release+0x934>
...
0000000000001588 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a4:	f2050513          	addi	a0,a0,-224 # 64c0 <tournament_release+0x134>
  ...
  if(pid == 0){
    ...
    15ce:	ef6a0a13          	addi	s4,s4,-266 # 64c0 <tournament_release+0x134>
      int n = write(fd, "1234567890", 10);
    15d2:	00005a97          	auipc	s5,0x5
    15d6:	74ea8a93          	addi	s5,s5,1870 # 6d20 <tournament_release+0x994>
      int fd = open("truncfile", O_WRONLY);
    15da:	4585                	li	a1,1
    15dc:	8552                	mv	a0,s4
    ...
    1646:	6ae50513          	addi	a0,a0,1710 # 6cf0 <tournament_release+0x964>
    ...
    1662:	6aa50513          	addi	a0,a0,1706 # 6d08 <tournament_release+0x97c>
    ...
    1680:	6b450513          	addi	a0,a0,1716 # 6d30 <tournament_release+0x9a4>
    ...
    169e:	e26a0a13          	addi	s4,s4,-474 # 64c0 <tournament_release+0x134>
    int n = write(fd, "xxx", 3);
    16a2:	00005a97          	auipc	s5,0x5
    16a6:	6aea8a93          	addi	s5,s5,1710 # 6d50 <tournament_release+0x9c4>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16f0:	dd450513          	addi	a0,a0,-556 # 64c0 <tournament_release+0x134>
  ...
  exit(xstatus);
    ...
    170e:	5fe50513          	addi	a0,a0,1534 # 6d08 <tournament_release+0x97c>
    ...
    172c:	63050513          	addi	a0,a0,1584 # 6d58 <tournament_release+0x9cc>
...
0000000000001742 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1754:	d1878793          	addi	a5,a5,-744 # 6468 <tournament_release+0xdc>
    1758:	fcf43023          	sd	a5,-64(s0)
    175c:	00005797          	auipc	a5,0x5
    1760:	61c78793          	addi	a5,a5,1564 # 6d78 <tournament_release+0x9ec>
    1764:	fcf43423          	sd	a5,-56(s0)
    1768:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176c:	00005517          	auipc	a0,0x5
    1770:	61450513          	addi	a0,a0,1556 # 6d80 <tournament_release+0x9f4>
  ...
  if(pid == 0) {
    ...
    179e:	5e650513          	addi	a0,a0,1510 # 6d80 <tournament_release+0x9f4>
    ...
    17ba:	5ea50513          	addi	a0,a0,1514 # 6da0 <tournament_release+0xa14>
    ...
    17d6:	51e50513          	addi	a0,a0,1310 # 6cf0 <tournament_release+0x964>
    ...
    17f2:	59a50513          	addi	a0,a0,1434 # 6d88 <tournament_release+0x9fc>
    ...
    1810:	c5c50513          	addi	a0,a0,-932 # 6468 <tournament_release+0xdc>
  ...
  if(xstatus != 0)
    ...
    1844:	57050513          	addi	a0,a0,1392 # 6db0 <tournament_release+0xa24>
    ...
    1860:	56c50513          	addi	a0,a0,1388 # 6dc8 <tournament_release+0xa3c>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1874:	51050513          	addi	a0,a0,1296 # 6d80 <tournament_release+0x9f4>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189e:	f9e50513          	addi	a0,a0,-98 # 6838 <tournament_release+0x4ac>
    ...
    18ba:	45250513          	addi	a0,a0,1106 # 6d08 <tournament_release+0x97c>
  ...
  unlink("echo-ok");
    ...
    18d4:	4b050513          	addi	a0,a0,1200 # 6d80 <tournament_release+0x9f4>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fe:	4e650513          	addi	a0,a0,1254 # 6de0 <tournament_release+0xa54>
...
000000000000191e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19c0:	43c50513          	addi	a0,a0,1084 # 6df8 <tournament_release+0xa6c>
    ...
    19fa:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9b>
{
    ...
    1a46:	3ce50513          	addi	a0,a0,974 # 6e10 <tournament_release+0xa84>
    ...
    1a62:	3ca50513          	addi	a0,a0,970 # 6e28 <tournament_release+0xa9c>
    ...
    1a94:	3b050513          	addi	a0,a0,944 # 6e40 <tournament_release+0xab4>
    ...
    1ad4:	39050513          	addi	a0,a0,912 # 6e60 <tournament_release+0xad4>
...
0000000000001aea <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b46:	1ae50513          	addi	a0,a0,430 # 6cf0 <tournament_release+0x964>
    ...
    1b62:	31a50513          	addi	a0,a0,794 # 6e78 <tournament_release+0xaec>
    ...
    1b7e:	31650513          	addi	a0,a0,790 # 6e90 <tournament_release+0xb04>
...
0000000000001b9e <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf6:	0fe50513          	addi	a0,a0,254 # 6cf0 <tournament_release+0x964>
    ...
    1c1a:	0da50513          	addi	a0,a0,218 # 6cf0 <tournament_release+0x964>
...
0000000000001c38 <forkfork>:
{
    ...
    1c94:	22050513          	addi	a0,a0,544 # 6eb0 <tournament_release+0xb24>
    ...
    1ca6:	f24080e7          	jalr	-220(ra) # 5bc6 <exit>
{
    ...
    1cec:	1d850513          	addi	a0,a0,472 # 6ec0 <tournament_release+0xb34>
...
0000000000001d02 <reparent2>:
{
  ...
  exit(0);
    ...
    1d3a:	3c250513          	addi	a0,a0,962 # 70f8 <tournament_release+0xd6c>
...
0000000000001d6a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd8:	32450513          	addi	a0,a0,804 # 70f8 <tournament_release+0xd6c>
    ...
    1e04:	f8850513          	addi	a0,a0,-120 # 6d88 <tournament_release+0x9fc>
    ...
    1e76:	06e50513          	addi	a0,a0,110 # 6ee0 <tournament_release+0xb54>
    ...
    1eaa:	05250513          	addi	a0,a0,82 # 6ef8 <tournament_release+0xb6c>
    ...
    1f10:	01450513          	addi	a0,a0,20 # 6f20 <tournament_release+0xb94>
...
0000000000001f90 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fb0:	52c50513          	addi	a0,a0,1324 # 64d8 <tournament_release+0x14c>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fec:	4f0a8a93          	addi	s5,s5,1264 # 64d8 <tournament_release+0x14c>
      link("cat", "x");
    1ff0:	00005b97          	auipc	s7,0x5
    1ff4:	f58b8b93          	addi	s7,s7,-168 # 6f48 <tournament_release+0xbbc>
    1ff8:	a825                	j	2030 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ffa:	85a6                	mv	a1,s1
    1ffc:	00005517          	auipc	a0,0x5
    2000:	cf450513          	addi	a0,a0,-780 # 6cf0 <tournament_release+0x964>
...
0000000000002092 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20c2:	eaa50513          	addi	a0,a0,-342 # 6f68 <tournament_release+0xbdc>
  ...
  if(wait(0) != -1){
    ...
    2124:	e3050513          	addi	a0,a0,-464 # 6f50 <tournament_release+0xbc4>
    ...
    2140:	e5450513          	addi	a0,a0,-428 # 6f90 <tournament_release+0xc04>
    ...
    215c:	e5050513          	addi	a0,a0,-432 # 6fa8 <tournament_release+0xc1c>
...
0000000000002172 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2198:	48090913          	addi	s2,s2,1152 # 1003d480 <base+0x1002d7f8>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21dc:	b1850513          	addi	a0,a0,-1256 # 6cf0 <tournament_release+0x964>
    ...
    21fe:	dc650513          	addi	a0,a0,-570 # 6fc0 <tournament_release+0xc34>
...
000000000000221e <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    2280:	a7450513          	addi	a0,a0,-1420 # 6cf0 <tournament_release+0x964>
    ...
    22ac:	d3850513          	addi	a0,a0,-712 # 6fe0 <tournament_release+0xc54>
...
00000000000022cc <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22dc:	d2050513          	addi	a0,a0,-736 # 6ff8 <tournament_release+0xc6c>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230e:	cee50513          	addi	a0,a0,-786 # 6ff8 <tournament_release+0xc6c>
  ...
  close(fd);
    ...
    2344:	cc870713          	addi	a4,a4,-824 # 7008 <tournament_release+0xc7c>
    ...
    2398:	d5450513          	addi	a0,a0,-684 # 70e8 <tournament_release+0xd5c>
    ...
    23bc:	d5050513          	addi	a0,a0,-688 # 7108 <tournament_release+0xd7c>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2410:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <base+0xfffffffffffef378>
    2414:	85a6                	mv	a1,s1
    2416:	00005517          	auipc	a0,0x5
    241a:	d1250513          	addi	a0,a0,-750 # 7128 <tournament_release+0xd9c>
    ...
    2436:	8be50513          	addi	a0,a0,-1858 # 6cf0 <tournament_release+0x964>
...
0000000000002456 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a4:	85050513          	addi	a0,a0,-1968 # 6cf0 <tournament_release+0x964>
...
00000000000024c4 <manywrites>:
{
  ...
  exit(0);
    ...
    2520:	bdc50513          	addi	a0,a0,-1060 # 70f8 <tournament_release+0xd6c>
    ...
    25d0:	b8450513          	addi	a0,a0,-1148 # 7150 <tournament_release+0xdc4>
    ...
    25f0:	f4c50513          	addi	a0,a0,-180 # 6538 <tournament_release+0x1ac>
...
000000000000260e <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2688:	7c478793          	addi	a5,a5,1988 # 7e48 <tournament_release+0x1abc>
  ...
  if(ret != -1){
    ...
    26ca:	aa250513          	addi	a0,a0,-1374 # 7168 <tournament_release+0xddc>
    ...
    26e8:	52c50513          	addi	a0,a0,1324 # 6c10 <tournament_release+0x884>
    ...
    2706:	52e50513          	addi	a0,a0,1326 # 6c30 <tournament_release+0x8a4>
    ...
    2726:	52e50513          	addi	a0,a0,1326 # 6c50 <tournament_release+0x8c4>
    ...
    2744:	53850513          	addi	a0,a0,1336 # 6c78 <tournament_release+0x8ec>
...
000000000000275a <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2790:	a1c50513          	addi	a0,a0,-1508 # 71a8 <tournament_release+0xe1c>
  ...
  if(n >= 0){
    ...
    27c2:	a0a50513          	addi	a0,a0,-1526 # 71c8 <tournament_release+0xe3c>
    ...
    27dc:	99850513          	addi	a0,a0,-1640 # 7170 <tournament_release+0xde4>
    ...
    27f6:	99650513          	addi	a0,a0,-1642 # 7188 <tournament_release+0xdfc>
    ...
    2810:	9a450513          	addi	a0,a0,-1628 # 71b0 <tournament_release+0xe24>
  ...
  unlink("rwsbrk");
    ...
    2834:	97850513          	addi	a0,a0,-1672 # 71a8 <tournament_release+0xe1c>
    2838:	00003097          	auipc	ra,0x3
    283c:	3de080e7          	jalr	990(ra) # 5c16 <unlink>
  fd = open("README", O_RDONLY);
    2840:	4581                	li	a1,0
    2842:	00004517          	auipc	a0,0x4
    2846:	dfe50513          	addi	a0,a0,-514 # 6640 <tournament_release+0x2b4>
  ...
  if(n >= 0){
    ...
    2870:	98c50513          	addi	a0,a0,-1652 # 71f8 <tournament_release+0xe6c>
    ...
    288a:	92a50513          	addi	a0,a0,-1750 # 71b0 <tournament_release+0xe24>
...
00000000000028b4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    28f0:	6705                	lui	a4,0x1
      *b = 99;
    28f2:	00d50023          	sb	a3,0(a0) # 40000000 <base+0x3fff0378>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    290a:	91a50513          	addi	a0,a0,-1766 # 7220 <tournament_release+0xe94>
  ...
  for(i = 0; i < 5000; i++){
    ...
    295c:	8e850513          	addi	a0,a0,-1816 # 7240 <tournament_release+0xeb4>
  ...
  if(c != a + 1){
    ...
    29c0:	8e450513          	addi	a0,a0,-1820 # 72a0 <tournament_release+0xf14>
    ...
    29e2:	88250513          	addi	a0,a0,-1918 # 7260 <tournament_release+0xed4>
    ...
    29fe:	88650513          	addi	a0,a0,-1914 # 7280 <tournament_release+0xef4>
...
0000000000002a3a <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2a9c:	fee78fa3          	sb	a4,-1(a5) # 63fffff <base+0x63f0377>
  a = sbrk(0);
    2aa0:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    2b00:	fff7c703          	lbu	a4,-1(a5) # 63fffff <base+0x63f0377>
  ...
  if(c != a){
    ...
    2b48:	77c50513          	addi	a0,a0,1916 # 72c0 <tournament_release+0xf34>
    ...
    2b64:	7a850513          	addi	a0,a0,1960 # 7308 <tournament_release+0xf7c>
    ...
    2b84:	7a850513          	addi	a0,a0,1960 # 7328 <tournament_release+0xf9c>
    ...
    2ba4:	7c850513          	addi	a0,a0,1992 # 7368 <tournament_release+0xfdc>
    ...
    2bc0:	7dc50513          	addi	a0,a0,2012 # 7398 <tournament_release+0x100c>
    ...
    2be0:	7f450513          	addi	a0,a0,2036 # 73d0 <tournament_release+0x1044>
...
0000000000002bf6 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c1a:	7e250513          	addi	a0,a0,2018 # 73f8 <tournament_release+0x106c>
    2c1e:	00003097          	auipc	ra,0x3
    2c22:	fe8080e7          	jalr	-24(ra) # 5c06 <open>
    2c26:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c28:	00004517          	auipc	a0,0x4
    2c2c:	7d050513          	addi	a0,a0,2000 # 73f8 <tournament_release+0x106c>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c80:	78450513          	addi	a0,a0,1924 # 7400 <tournament_release+0x1074>
    ...
    2c9c:	78050513          	addi	a0,a0,1920 # 7418 <tournament_release+0x108c>
    ...
    2cb8:	14450513          	addi	a0,a0,324 # 6df8 <tournament_release+0xa6c>
...
0000000000002cce <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2ce2:	75250513          	addi	a0,a0,1874 # 7430 <tournament_release+0x10a4>
  ...
  close(fd);
    ...
    2d2a:	fe250513          	addi	a0,a0,-30 # 6d08 <tournament_release+0x97c>
...
0000000000002d40 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d78:	38450513          	addi	a0,a0,900 # 70f8 <tournament_release+0xd6c>
  ...
  if(pid == 0){
    ...
    2dce:	32e50513          	addi	a0,a0,814 # 70f8 <tournament_release+0xd6c>
  ...
  if(pid == 0){
    ...
    2e2e:	2ce50513          	addi	a0,a0,718 # 70f8 <tournament_release+0xd6c>
...
0000000000002f2a <sbrk8000>:
{
  ...
  *(top-1) = *(top-1) + 1;
    2f4a:	fff54783          	lbu	a5,-1(a0) # ffffffff7fffffff <base+0xffffffff7fff0377>
...
0000000000002f60 <execout>:
{
  ...
  exit(0);
    ...
    2fa2:	15a50513          	addi	a0,a0,346 # 70f8 <tournament_release+0xd6c>
    ...
    2ff6:	47650513          	addi	a0,a0,1142 # 6468 <tournament_release+0xdc>
    2ffa:	faa43c23          	sd	a0,-72(s0)
    2ffe:	00003797          	auipc	a5,0x3
    3002:	4da78793          	addi	a5,a5,1242 # 64d8 <tournament_release+0x14c>
...
0000000000003024 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3034:	5d850513          	addi	a0,a0,1496 # 7608 <tournament_release+0x127c>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3046:	41e50513          	addi	a0,a0,1054 # 7460 <tournament_release+0x10d4>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    305c:	46050513          	addi	a0,a0,1120 # 74b8 <tournament_release+0x112c>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    307a:	4ba50513          	addi	a0,a0,1210 # 7530 <tournament_release+0x11a4>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3096:	50e50513          	addi	a0,a0,1294 # 75a0 <tournament_release+0x1214>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a8:	55450513          	addi	a0,a0,1364 # 75f8 <tournament_release+0x126c>
  ...
  unlink("12345678901234");
    ...
    3126:	31650513          	addi	a0,a0,790 # 7438 <tournament_release+0x10ac>
    ...
    3142:	34250513          	addi	a0,a0,834 # 7480 <tournament_release+0x10f4>
    ...
    315e:	38e50513          	addi	a0,a0,910 # 74e8 <tournament_release+0x115c>
    ...
    317a:	3ea50513          	addi	a0,a0,1002 # 7560 <tournament_release+0x11d4>
    ...
    3196:	42e50513          	addi	a0,a0,1070 # 75c0 <tournament_release+0x1234>
    ...
    31b2:	46a50513          	addi	a0,a0,1130 # 7618 <tournament_release+0x128c>
...
00000000000031c8 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31fe:	45650513          	addi	a0,a0,1110 # 7650 <tournament_release+0x12c4>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3228:	43c50513          	addi	a0,a0,1084 # 7660 <tournament_release+0x12d4>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b8:	39c50513          	addi	a0,a0,924 # 7650 <tournament_release+0x12c4>
  ...
  unlink("diskfulldir");
    ...
    32cc:	38850513          	addi	a0,a0,904 # 7650 <tournament_release+0x12c4>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33fa:	28a50513          	addi	a0,a0,650 # 7680 <tournament_release+0x12f4>
...
0000000000003408 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3418:	29c50513          	addi	a0,a0,668 # 76b0 <tournament_release+0x1324>
  ...
  if(chdir("iputdir") < 0){
    ...
    342c:	28850513          	addi	a0,a0,648 # 76b0 <tournament_release+0x1324>
  ...
  if(unlink("../iputdir") < 0){
    ...
    3440:	2b450513          	addi	a0,a0,692 # 76f0 <tournament_release+0x1364>
  ...
  if(chdir("/") < 0){
    ...
    3454:	2d050513          	addi	a0,a0,720 # 7720 <tournament_release+0x1394>
    ...
    3474:	24850513          	addi	a0,a0,584 # 76b8 <tournament_release+0x132c>
    ...
    3490:	24450513          	addi	a0,a0,580 # 76d0 <tournament_release+0x1344>
    ...
    34ac:	25850513          	addi	a0,a0,600 # 7700 <tournament_release+0x1374>
    ...
    34c8:	26450513          	addi	a0,a0,612 # 7728 <tournament_release+0x139c>
...
00000000000034de <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34fc:	1b850513          	addi	a0,a0,440 # 76b0 <tournament_release+0x1324>
    ...
    3510:	1a450513          	addi	a0,a0,420 # 76b0 <tournament_release+0x1324>
    ...
    3524:	1d050513          	addi	a0,a0,464 # 76f0 <tournament_release+0x1364>
    ...
    3544:	7b050513          	addi	a0,a0,1968 # 6cf0 <tournament_release+0x964>
    ...
    3560:	15c50513          	addi	a0,a0,348 # 76b8 <tournament_release+0x132c>
    ...
    357c:	1c850513          	addi	a0,a0,456 # 7740 <tournament_release+0x13b4>
    ...
    3598:	16c50513          	addi	a0,a0,364 # 7700 <tournament_release+0x1374>
...
00000000000035c6 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d6:	18650513          	addi	a0,a0,390 # 7758 <tournament_release+0x13cc>
  ...
  if(chdir("dir0") < 0){
    ...
    35ea:	17250513          	addi	a0,a0,370 # 7758 <tournament_release+0x13cc>
  ...
  if(chdir("..") < 0){
    ...
    35fe:	17e50513          	addi	a0,a0,382 # 7778 <tournament_release+0x13ec>
  ...
  if(unlink("dir0") < 0){
    ...
    3612:	14a50513          	addi	a0,a0,330 # 7758 <tournament_release+0x13cc>
    ...
    3632:	08a50513          	addi	a0,a0,138 # 76b8 <tournament_release+0x132c>
    ...
    364e:	11650513          	addi	a0,a0,278 # 7760 <tournament_release+0x13d4>
    ...
    366a:	11a50513          	addi	a0,a0,282 # 7780 <tournament_release+0x13f4>
    ...
    3686:	11650513          	addi	a0,a0,278 # 7798 <tournament_release+0x140c>
...
000000000000369c <subdir>:
{
  ...
  unlink("ff");
    ...
    36ae:	23650513          	addi	a0,a0,566 # 78e0 <tournament_release+0x1554>
    36b2:	00002097          	auipc	ra,0x2
    36b6:	564080e7          	jalr	1380(ra) # 5c16 <unlink>
  if(mkdir("dd") != 0){
    36ba:	00004517          	auipc	a0,0x4
    36be:	0f650513          	addi	a0,a0,246 # 77b0 <tournament_release+0x1424>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d6:	0fe50513          	addi	a0,a0,254 # 77d0 <tournament_release+0x1444>
  ...
  write(fd, "ff", 2);
    ...
    36ee:	1f658593          	addi	a1,a1,502 # 78e0 <tournament_release+0x1554>
  ...
  if(unlink("dd") >= 0){
    ...
    3708:	0ac50513          	addi	a0,a0,172 # 77b0 <tournament_release+0x1424>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    371c:	11050513          	addi	a0,a0,272 # 7828 <tournament_release+0x149c>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3734:	12050513          	addi	a0,a0,288 # 7850 <tournament_release+0x14c4>
  ...
  write(fd, "FF", 2);
    ...
    374c:	13858593          	addi	a1,a1,312 # 7880 <tournament_release+0x14f4>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3768:	12450513          	addi	a0,a0,292 # 7888 <tournament_release+0x14fc>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37b0:	12c58593          	addi	a1,a1,300 # 78d8 <tournament_release+0x154c>
    37b4:	00004517          	auipc	a0,0x4
    37b8:	09c50513          	addi	a0,a0,156 # 7850 <tournament_release+0x14c4>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37cc:	08850513          	addi	a0,a0,136 # 7850 <tournament_release+0x14c4>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37e2:	07250513          	addi	a0,a0,114 # 7850 <tournament_release+0x14c4>
  ...
  if(chdir("dd") != 0){
    ...
    37f6:	fbe50513          	addi	a0,a0,-66 # 77b0 <tournament_release+0x1424>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    380a:	16a50513          	addi	a0,a0,362 # 7970 <tournament_release+0x15e4>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    381e:	18650513          	addi	a0,a0,390 # 79a0 <tournament_release+0x1614>
  ...
  if(chdir("./..") != 0){
    ...
    3832:	1a250513          	addi	a0,a0,418 # 79d0 <tournament_release+0x1644>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3848:	09450513          	addi	a0,a0,148 # 78d8 <tournament_release+0x154c>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3882:	fd250513          	addi	a0,a0,-46 # 7850 <tournament_release+0x14c4>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    389a:	1ca50513          	addi	a0,a0,458 # 7a60 <tournament_release+0x16d4>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38b2:	1e250513          	addi	a0,a0,482 # 7a90 <tournament_release+0x1704>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38ca:	eea50513          	addi	a0,a0,-278 # 77b0 <tournament_release+0x1424>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38e0:	ed450513          	addi	a0,a0,-300 # 77b0 <tournament_release+0x1424>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f6:	ebe50513          	addi	a0,a0,-322 # 77b0 <tournament_release+0x1424>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    390a:	21a58593          	addi	a1,a1,538 # 7b20 <tournament_release+0x1794>
    390e:	00004517          	auipc	a0,0x4
    3912:	15250513          	addi	a0,a0,338 # 7a60 <tournament_release+0x16d4>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3926:	1fe58593          	addi	a1,a1,510 # 7b20 <tournament_release+0x1794>
    392a:	00004517          	auipc	a0,0x4
    392e:	16650513          	addi	a0,a0,358 # 7a90 <tournament_release+0x1704>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    3942:	f9a58593          	addi	a1,a1,-102 # 78d8 <tournament_release+0x154c>
    3946:	00004517          	auipc	a0,0x4
    394a:	e8a50513          	addi	a0,a0,-374 # 77d0 <tournament_release+0x1444>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    395e:	10650513          	addi	a0,a0,262 # 7a60 <tournament_release+0x16d4>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    3972:	12250513          	addi	a0,a0,290 # 7a90 <tournament_release+0x1704>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3986:	f5650513          	addi	a0,a0,-170 # 78d8 <tournament_release+0x154c>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    399a:	0fa50513          	addi	a0,a0,250 # 7a90 <tournament_release+0x1704>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39ae:	0b650513          	addi	a0,a0,182 # 7a60 <tournament_release+0x16d4>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39c2:	e1250513          	addi	a0,a0,-494 # 77d0 <tournament_release+0x1444>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d6:	29e50513          	addi	a0,a0,670 # 7c70 <tournament_release+0x18e4>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39ea:	ef250513          	addi	a0,a0,-270 # 78d8 <tournament_release+0x154c>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39fe:	dd650513          	addi	a0,a0,-554 # 77d0 <tournament_release+0x1444>
  ...
  if(unlink("dd") == 0){
    ...
    3a12:	da250513          	addi	a0,a0,-606 # 77b0 <tournament_release+0x1424>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a26:	2be50513          	addi	a0,a0,702 # 7ce0 <tournament_release+0x1954>
  ...
  if(unlink("dd") < 0){
    ...
    3a3a:	d7a50513          	addi	a0,a0,-646 # 77b0 <tournament_release+0x1424>
    ...
    3a5c:	d6050513          	addi	a0,a0,-672 # 77b8 <tournament_release+0x142c>
    ...
    3a78:	d6450513          	addi	a0,a0,-668 # 77d8 <tournament_release+0x144c>
    ...
    3a94:	d6850513          	addi	a0,a0,-664 # 77f8 <tournament_release+0x146c>
    ...
    3ab0:	d8450513          	addi	a0,a0,-636 # 7830 <tournament_release+0x14a4>
    ...
    3acc:	d9850513          	addi	a0,a0,-616 # 7860 <tournament_release+0x14d4>
    ...
    3ae8:	db450513          	addi	a0,a0,-588 # 7898 <tournament_release+0x150c>
    ...
    3b04:	db850513          	addi	a0,a0,-584 # 78b8 <tournament_release+0x152c>
    ...
    3b20:	dcc50513          	addi	a0,a0,-564 # 78e8 <tournament_release+0x155c>
    ...
    3b3c:	dd850513          	addi	a0,a0,-552 # 7910 <tournament_release+0x1584>
    ...
    3b58:	ddc50513          	addi	a0,a0,-548 # 7930 <tournament_release+0x15a4>
    ...
    3b74:	de850513          	addi	a0,a0,-536 # 7958 <tournament_release+0x15cc>
    ...
    3b90:	df450513          	addi	a0,a0,-524 # 7980 <tournament_release+0x15f4>
    ...
    3bac:	e0850513          	addi	a0,a0,-504 # 79b0 <tournament_release+0x1624>
    ...
    3bc8:	e1450513          	addi	a0,a0,-492 # 79d8 <tournament_release+0x164c>
    ...
    3be4:	e1050513          	addi	a0,a0,-496 # 79f0 <tournament_release+0x1664>
    ...
    3c00:	e1450513          	addi	a0,a0,-492 # 7a10 <tournament_release+0x1684>
    ...
    3c1c:	e1850513          	addi	a0,a0,-488 # 7a30 <tournament_release+0x16a4>
    ...
    3c38:	e3c50513          	addi	a0,a0,-452 # 7a70 <tournament_release+0x16e4>
    ...
    3c54:	e5050513          	addi	a0,a0,-432 # 7aa0 <tournament_release+0x1714>
    ...
    3c70:	e5450513          	addi	a0,a0,-428 # 7ac0 <tournament_release+0x1734>
    ...
    3c8c:	e5850513          	addi	a0,a0,-424 # 7ae0 <tournament_release+0x1754>
    ...
    3ca8:	e5c50513          	addi	a0,a0,-420 # 7b00 <tournament_release+0x1774>
    ...
    3cc4:	e7050513          	addi	a0,a0,-400 # 7b30 <tournament_release+0x17a4>
    ...
    3ce0:	e7c50513          	addi	a0,a0,-388 # 7b58 <tournament_release+0x17cc>
    ...
    3cfc:	e8850513          	addi	a0,a0,-376 # 7b80 <tournament_release+0x17f4>
    ...
    3d18:	e9450513          	addi	a0,a0,-364 # 7ba8 <tournament_release+0x181c>
    ...
    3d34:	e9850513          	addi	a0,a0,-360 # 7bc8 <tournament_release+0x183c>
    ...
    3d50:	e9c50513          	addi	a0,a0,-356 # 7be8 <tournament_release+0x185c>
    ...
    3d6c:	ea850513          	addi	a0,a0,-344 # 7c10 <tournament_release+0x1884>
    ...
    3d88:	eac50513          	addi	a0,a0,-340 # 7c30 <tournament_release+0x18a4>
    ...
    3da4:	eb050513          	addi	a0,a0,-336 # 7c50 <tournament_release+0x18c4>
    ...
    3dc0:	ebc50513          	addi	a0,a0,-324 # 7c78 <tournament_release+0x18ec>
    ...
    3ddc:	b3850513          	addi	a0,a0,-1224 # 7910 <tournament_release+0x1584>
    ...
    3df8:	ea450513          	addi	a0,a0,-348 # 7c98 <tournament_release+0x190c>
    ...
    3e14:	ea850513          	addi	a0,a0,-344 # 7cb8 <tournament_release+0x192c>
    ...
    3e30:	ebc50513          	addi	a0,a0,-324 # 7ce8 <tournament_release+0x195c>
    ...
    3e4c:	ec050513          	addi	a0,a0,-320 # 7d08 <tournament_release+0x197c>
...
0000000000003e62 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e72:	eb250513          	addi	a0,a0,-334 # 7d20 <tournament_release+0x1994>
  ...
  if(chdir("dots") != 0){
    ...
    3e84:	ea050513          	addi	a0,a0,-352 # 7d20 <tournament_release+0x1994>
  ...
  if(unlink(".") == 0){
    ...
    3e96:	cbe50513          	addi	a0,a0,-834 # 6b50 <tournament_release+0x7c4>
  ...
  if(unlink("..") == 0){
    ...
    3ea8:	8d450513          	addi	a0,a0,-1836 # 7778 <tournament_release+0x13ec>
  ...
  if(chdir("/") != 0){
    ...
    3eba:	86a50513          	addi	a0,a0,-1942 # 7720 <tournament_release+0x1394>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ecc:	ec050513          	addi	a0,a0,-320 # 7d88 <tournament_release+0x19fc>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ede:	ed650513          	addi	a0,a0,-298 # 7db0 <tournament_release+0x1a24>
  ...
  if(unlink("dots") != 0){
    ...
    3ef0:	e3450513          	addi	a0,a0,-460 # 7d20 <tournament_release+0x1994>
    ...
    3f0e:	e1e50513          	addi	a0,a0,-482 # 7d28 <tournament_release+0x199c>
    ...
    3f2a:	e1a50513          	addi	a0,a0,-486 # 7d40 <tournament_release+0x19b4>
    ...
    3f46:	e1650513          	addi	a0,a0,-490 # 7d58 <tournament_release+0x19cc>
    ...
    3f62:	e1250513          	addi	a0,a0,-494 # 7d70 <tournament_release+0x19e4>
    ...
    3f7e:	7ae50513          	addi	a0,a0,1966 # 7728 <tournament_release+0x139c>
    ...
    3f9a:	dfa50513          	addi	a0,a0,-518 # 7d90 <tournament_release+0x1a04>
    ...
    3fb6:	e0650513          	addi	a0,a0,-506 # 7db8 <tournament_release+0x1a2c>
    ...
    3fd2:	e0a50513          	addi	a0,a0,-502 # 7dd8 <tournament_release+0x1a4c>
...
0000000000003fe8 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ffe:	dfe50513          	addi	a0,a0,-514 # 7df8 <tournament_release+0x1a6c>
  ...
  if(chdir("dirfile") == 0){
    ...
    401a:	de250513          	addi	a0,a0,-542 # 7df8 <tournament_release+0x1a6c>
  ...
  fd = open("dirfile/xx", 0);
    ...
    402e:	e1650513          	addi	a0,a0,-490 # 7e40 <tournament_release+0x1ab4>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4046:	dfe50513          	addi	a0,a0,-514 # 7e40 <tournament_release+0x1ab4>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    405a:	dea50513          	addi	a0,a0,-534 # 7e40 <tournament_release+0x1ab4>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    406e:	dd650513          	addi	a0,a0,-554 # 7e40 <tournament_release+0x1ab4>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    4082:	dc258593          	addi	a1,a1,-574 # 7e40 <tournament_release+0x1ab4>
    4086:	00002517          	auipc	a0,0x2
    408a:	5ba50513          	addi	a0,a0,1466 # 6640 <tournament_release+0x2b4>
  ...
  if(unlink("dirfile") != 0){
    ...
    409e:	d5e50513          	addi	a0,a0,-674 # 7df8 <tournament_release+0x1a6c>
  ...
  fd = open(".", O_RDWR);
    ...
    40b4:	aa050513          	addi	a0,a0,-1376 # 6b50 <tournament_release+0x7c4>
  ...
  fd = open(".", 0);
    ...
    40ca:	a8a50513          	addi	a0,a0,-1398 # 6b50 <tournament_release+0x7c4>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40de:	3fe58593          	addi	a1,a1,1022 # 64d8 <tournament_release+0x14c>
  ...
  close(fd);
    ...
    410a:	cfa50513          	addi	a0,a0,-774 # 7e00 <tournament_release+0x1a74>
    ...
    4126:	cfe50513          	addi	a0,a0,-770 # 7e20 <tournament_release+0x1a94>
    ...
    4142:	d1250513          	addi	a0,a0,-750 # 7e50 <tournament_release+0x1ac4>
    ...
    415e:	cf650513          	addi	a0,a0,-778 # 7e50 <tournament_release+0x1ac4>
    ...
    417a:	d0250513          	addi	a0,a0,-766 # 7e78 <tournament_release+0x1aec>
    ...
    4196:	d0e50513          	addi	a0,a0,-754 # 7ea0 <tournament_release+0x1b14>
    ...
    41b2:	d1a50513          	addi	a0,a0,-742 # 7ec8 <tournament_release+0x1b3c>
    ...
    41ce:	d2650513          	addi	a0,a0,-730 # 7ef0 <tournament_release+0x1b64>
    ...
    41ea:	d2a50513          	addi	a0,a0,-726 # 7f10 <tournament_release+0x1b84>
    ...
    4206:	d3650513          	addi	a0,a0,-714 # 7f38 <tournament_release+0x1bac>
...
000000000000421c <iref>:
{
    ...
    423a:	d1aa0a13          	addi	s4,s4,-742 # 7f50 <tournament_release+0x1bc4>
    mkdir("");
    423e:	00004497          	auipc	s1,0x4
    4242:	81a48493          	addi	s1,s1,-2022 # 7a58 <tournament_release+0x16cc>
    link("README", "");
    4246:	00002a97          	auipc	s5,0x2
    424a:	3faa8a93          	addi	s5,s5,1018 # 6640 <tournament_release+0x2b4>
    fd = open("xx", O_CREATE);
    424e:	00004997          	auipc	s3,0x4
    4252:	bfa98993          	addi	s3,s3,-1030 # 7e48 <tournament_release+0x1abc>
    4256:	a891                	j	42aa <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4258:	85da                	mv	a1,s6
    425a:	00004517          	auipc	a0,0x4
    425e:	cfe50513          	addi	a0,a0,-770 # 7f58 <tournament_release+0x1bcc>
    ...
    427a:	cfa50513          	addi	a0,a0,-774 # 7f70 <tournament_release+0x1be4>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    430e:	46e98993          	addi	s3,s3,1134 # 7778 <tournament_release+0x13ec>
    unlink("irefd");
    4312:	00004917          	auipc	s2,0x4
    4316:	c3e90913          	addi	s2,s2,-962 # 7f50 <tournament_release+0x1bc4>
    chdir("..");
    431a:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4336:	3ee50513          	addi	a0,a0,1006 # 7720 <tournament_release+0x1394>
...
0000000000004356 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4366:	c2650513          	addi	a0,a0,-986 # 7f88 <tournament_release+0x1bfc>
  ...
  if(pid == 0){
    ...
    438a:	c0250513          	addi	a0,a0,-1022 # 7f88 <tournament_release+0x1bfc>
    ...
    43a0:	c0c50513          	addi	a0,a0,-1012 # 7fa8 <tournament_release+0x1c1c>
    ...
    43bc:	bd850513          	addi	a0,a0,-1064 # 7f90 <tournament_release+0x1c04>
    ...
    43d8:	91c50513          	addi	a0,a0,-1764 # 6cf0 <tournament_release+0x964>
  ...
  if(unlink("oidir") != 0){
    ...
    4406:	b8650513          	addi	a0,a0,-1146 # 7f88 <tournament_release+0x1bfc>
    ...
    441a:	aca50513          	addi	a0,a0,-1334 # 6ee0 <tournament_release+0xb54>
...
0000000000004448 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4458:	b7c50513          	addi	a0,a0,-1156 # 7fd0 <tournament_release+0x1c44>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    4484:	b5050513          	addi	a0,a0,-1200 # 7fd0 <tournament_release+0x1c44>
  ...
  sleep(10); // one second
    ...
    44bc:	9f850513          	addi	a0,a0,-1544 # 6eb0 <tournament_release+0xb24>
    ...
    44d6:	afe48493          	addi	s1,s1,-1282 # 7fd0 <tournament_release+0x1c44>
    44da:	4581                	li	a1,0
    44dc:	8526                	mv	a0,s1
...
0000000000004518 <killstatus>:
{
  ...
  exit(0);
    ...
    457e:	77650513          	addi	a0,a0,1910 # 6cf0 <tournament_release+0x964>
    ...
    45a4:	a4050513          	addi	a0,a0,-1472 # 7fe0 <tournament_release+0x1c54>
...
00000000000045ba <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45e4:	8d050513          	addi	a0,a0,-1840 # 6eb0 <tournament_release+0xb24>
  ...
  if(pid2 == 0)
    ...
    4612:	6e250513          	addi	a0,a0,1762 # 6cf0 <tournament_release+0x964>
  ...
  if(pid3 == 0){
    ...
    4656:	e8658593          	addi	a1,a1,-378 # 64d8 <tournament_release+0x14c>
    ...
    4680:	67450513          	addi	a0,a0,1652 # 6cf0 <tournament_release+0x964>
    ...
    469c:	96850513          	addi	a0,a0,-1688 # 8000 <tournament_release+0x1c74>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d8:	94450513          	addi	a0,a0,-1724 # 8018 <tournament_release+0x1c8c>
  ...
  printf("kill... ");
    ...
    4704:	93050513          	addi	a0,a0,-1744 # 8030 <tournament_release+0x1ca4>
  ...
  printf("wait... ");
    ...
    4732:	91250513          	addi	a0,a0,-1774 # 8040 <tournament_release+0x1cb4>
...
000000000000475e <reparent>:
{
  ...
  exit(0);
    ...
    47b2:	54250513          	addi	a0,a0,1346 # 6cf0 <tournament_release+0x964>
    ...
    47ce:	6ae50513          	addi	a0,a0,1710 # 6e78 <tournament_release+0xaec>
...
000000000000480e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4844:	5b850513          	addi	a0,a0,1464 # 6df8 <tournament_release+0xa6c>
    ...
    4878:	c6458593          	addi	a1,a1,-924 # 64d8 <tournament_release+0x14c>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    493c:	71850513          	addi	a0,a0,1816 # 8050 <tournament_release+0x1cc4>
    ...
    4958:	39c50513          	addi	a0,a0,924 # 6cf0 <tournament_release+0x964>
    ...
    498e:	6705                	lui	a4,0x1
      n += *(a+i);
    4990:	0007c683          	lbu	a3,0(a5) # 6400000 <base+0x63f0378>
    ...
    49a4:	6d050513          	addi	a0,a0,1744 # 8070 <tournament_release+0x1ce4>
...
00000000000049c4 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a48:	65c50513          	addi	a0,a0,1628 # 80a0 <tournament_release+0x1d14>
...
0000000000004a68 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    4a84:	64050513          	addi	a0,a0,1600 # 80c0 <tournament_release+0x1d34>
    4a88:	00001097          	auipc	ra,0x1
    4a8c:	18e080e7          	jalr	398(ra) # 5c16 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    4a90:	20200593          	li	a1,514
    4a94:	00003517          	auipc	a0,0x3
    4a98:	62c50513          	addi	a0,a0,1580 # 80c0 <tournament_release+0x1d34>
  ...
  if(pid == 0) {
    ...
    4afe:	5d650513          	addi	a0,a0,1494 # 80d0 <tournament_release+0x1d44>
    ...
    4b1a:	5e250513          	addi	a0,a0,1506 # 80f8 <tournament_release+0x1d6c>
  ...
  fd = open("sharedfd", 0);
    ...
    4b5e:	56650513          	addi	a0,a0,1382 # 80c0 <tournament_release+0x1d34>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b9e:	57e50513          	addi	a0,a0,1406 # 8118 <tournament_release+0x1d8c>
  ...
  unlink("sharedfd");
    ...
    4bda:	4ea50513          	addi	a0,a0,1258 # 80c0 <tournament_release+0x1d34>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c00:	54450513          	addi	a0,a0,1348 # 8140 <tournament_release+0x1db4>
...
0000000000004c20 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c46:	7ce78793          	addi	a5,a5,1998 # 6410 <tournament_release+0x84>
    4c4a:	f6f43823          	sd	a5,-144(s0)
    4c4e:	00001797          	auipc	a5,0x1
    4c52:	7ca78793          	addi	a5,a5,1994 # 6418 <tournament_release+0x8c>
    4c56:	f6f43c23          	sd	a5,-136(s0)
    4c5a:	00001797          	auipc	a5,0x1
    4c5e:	7c678793          	addi	a5,a5,1990 # 6420 <tournament_release+0x94>
    4c62:	f8f43023          	sd	a5,-128(s0)
    4c66:	00001797          	auipc	a5,0x1
    4c6a:	7c278793          	addi	a5,a5,1986 # 6428 <tournament_release+0x9c>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4ce2:	41a50513          	addi	a0,a0,1050 # 70f8 <tournament_release+0xd6c>
    ...
    4d5e:	3fe50513          	addi	a0,a0,1022 # 8158 <tournament_release+0x1dcc>
    ...
    4d78:	3f450513          	addi	a0,a0,1012 # 8168 <tournament_release+0x1ddc>
    ...
    4da0:	3e450513          	addi	a0,a0,996 # 8180 <tournament_release+0x1df4>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e2e:	36650513          	addi	a0,a0,870 # 8190 <tournament_release+0x1e04>
...
0000000000004e62 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e90:	31cb8b93          	addi	s7,s7,796 # 81a8 <tournament_release+0x1e1c>
  for(i = 0; i < N; i++){
    ...
    4ed2:	2e250513          	addi	a0,a0,738 # 81b0 <tournament_release+0x1e24>
    ...
    4ef0:	2bc50513          	addi	a0,a0,700 # 81a8 <tournament_release+0x1e1c>
  ...
  fd = open(".", 0);
    ...
    4f28:	c2c50513          	addi	a0,a0,-980 # 6b50 <tournament_release+0x7c4>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f9e:	23650513          	addi	a0,a0,566 # 81d0 <tournament_release+0x1e44>
    ...
    4fbe:	23650513          	addi	a0,a0,566 # 81f0 <tournament_release+0x1e64>
  ...
  for(i = 0; i < N; i++){
    ...
    4ff6:	22650513          	addi	a0,a0,550 # 8218 <tournament_release+0x1e8c>
    ...
    5012:	ce250513          	addi	a0,a0,-798 # 6cf0 <tournament_release+0x964>
...
00000000000051bc <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5244:	01050513          	addi	a0,a0,16 # 8250 <tournament_release+0x1ec4>
  ...
  for(i = 0; ; i++){
    ...
    52a8:	fbc50513          	addi	a0,a0,-68 # 8260 <tournament_release+0x1ed4>
    ...
    52c4:	fc050513          	addi	a0,a0,-64 # 8280 <tournament_release+0x1ef4>
    ...
    52e0:	fc450513          	addi	a0,a0,-60 # 82a0 <tournament_release+0x1f14>
    ...
    52fc:	fc850513          	addi	a0,a0,-56 # 82c0 <tournament_release+0x1f34>
    ...
    5318:	fcc50513          	addi	a0,a0,-52 # 82e0 <tournament_release+0x1f54>
    ...
    5334:	fc850513          	addi	a0,a0,-56 # 82f8 <tournament_release+0x1f6c>
  ...
  unlink("bigfile.dat");
    ...
    5362:	ef250513          	addi	a0,a0,-270 # 8250 <tournament_release+0x1ec4>
    ...
    5386:	f9650513          	addi	a0,a0,-106 # 8318 <tournament_release+0x1f8c>
...
000000000000539c <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53be:	f7e50513          	addi	a0,a0,-130 # 8338 <tournament_release+0x1fac>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    53de:	f6ec8c93          	addi	s9,s9,-146 # 8348 <tournament_release+0x1fbc>
    int total = 0;
    53e2:	4d81                	li	s11,0
    ...
    5458:	f0450513          	addi	a0,a0,-252 # 8358 <tournament_release+0x1fcc>
  ...
  printf("fsfull test finished\n");
    ...
    54ce:	eae50513          	addi	a0,a0,-338 # 8378 <tournament_release+0x1fec>
    ...
    551e:	e4e50513          	addi	a0,a0,-434 # 8368 <tournament_release+0x1fdc>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5550:	e4450513          	addi	a0,a0,-444 # 8390 <tournament_release+0x2004>
  ...
  if(pid == 0) {
    ...
    5580:	e3c50513          	addi	a0,a0,-452 # 83b8 <tournament_release+0x202c>
    ...
    55a4:	e0050513          	addi	a0,a0,-512 # 83a0 <tournament_release+0x2014>
    ...
    55cc:	df850513          	addi	a0,a0,-520 # 83c0 <tournament_release+0x2034>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    561c:	db050513          	addi	a0,a0,-592 # 83c8 <tournament_release+0x203c>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5676:	e6698993          	addi	s3,s3,-410 # 64d8 <tournament_release+0x14c>
      uint64 a = (uint64) sbrk(4096);
    ...
    56a8:	d7c50513          	addi	a0,a0,-644 # 8420 <tournament_release+0x2094>
    ...
    56c2:	d2250513          	addi	a0,a0,-734 # 83e0 <tournament_release+0x2054>
    ...
    56dc:	d2850513          	addi	a0,a0,-728 # 8400 <tournament_release+0x2074>
  ...
  while(1){
    ...
    572a:	d1a50513          	addi	a0,a0,-742 # 8440 <tournament_release+0x20b4>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    578c:	cd8b8b93          	addi	s7,s7,-808 # 8460 <tournament_release+0x20d4>
    int free0 = countfree();
    int free1 = 0;
    ...
    579e:	cfec8c93          	addi	s9,s9,-770 # 8498 <tournament_release+0x210c>
      if (runtests(slowtests, justone)) {
    57a2:	00004c17          	auipc	s8,0x4
    57a6:	c3ec0c13          	addi	s8,s8,-962 # 93e0 <slowtests>
        printf("usertests slow tests starting\n");
    57aa:	00003d17          	auipc	s10,0x3
    57ae:	cced0d13          	addi	s10,s10,-818 # 8478 <tournament_release+0x20ec>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    58a4:	c2858593          	addi	a1,a1,-984 # 84c8 <tournament_release+0x213c>
    ...
    58ba:	c6a58593          	addi	a1,a1,-918 # 8520 <tournament_release+0x2194>
    ...
    58d0:	c4c58593          	addi	a1,a1,-948 # 8518 <tournament_release+0x218c>
  ...
  int continuous = 0;
    ...
    58fc:	bd850513          	addi	a0,a0,-1064 # 84d0 <tournament_release+0x2144>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5928:	bdc50513          	addi	a0,a0,-1060 # 8500 <tournament_release+0x2174>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5cce:	bc650513          	addi	a0,a0,-1082 # 8890 <digits>
    5cd2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5d96:	00003b97          	auipc	s7,0x3
    5d9a:	afab8b93          	addi	s7,s7,-1286 # 8890 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5ed4:	bdf9                	j	5db2 <vprintf+0x60>
          s = "(null)";
    5ed6:	00003917          	auipc	s2,0x3
    5eda:	9b290913          	addi	s2,s2,-1614 # 8888 <tournament_release+0x24fc>
        while(*s != 0){
...
malloc(uint nbytes)
{
  ...
  if(p == (char*)-1)
    ...
    6078:	c1478793          	addi	a5,a5,-1004 # fc88 <base>
...
0000000000006100 <tournament_create>:
...
int tournament_create(int processes) {
    6100:	715d                	addi	sp,sp,-80
    6102:	e486                	sd	ra,72(sp)
    6104:	e0a2                	sd	s0,64(sp)
    6106:	fc26                	sd	s1,56(sp)
    6108:	f84a                	sd	s2,48(sp)
    610a:	f44e                	sd	s3,40(sp)
    610c:	f052                	sd	s4,32(sp)
    610e:	ec56                	sd	s5,24(sp)
    6110:	e85a                	sd	s6,16(sp)
    6112:	e45e                	sd	s7,8(sp)
    6114:	0880                	addi	s0,sp,80
    // Check if the number of processes is valid (power of 2 up to 16)
    if (processes <= 0 || processes > 16 || (processes & (processes - 1)) != 0) {
    6116:	fff5071b          	addiw	a4,a0,-1
    611a:	47bd                	li	a5,15
    611c:	14e7e163          	bltu	a5,a4,625e <tournament_create+0x15e>
    6120:	8aaa                	mv	s5,a0
    6122:	357d                	addiw	a0,a0,-1
    6124:	8b3a                	mv	s6,a4
    6126:	015777b3          	and	a5,a4,s5
    612a:	12079c63          	bnez	a5,6262 <tournament_create+0x162>
        return -1;  // Not a power of 2 or out of range
    }

    num_processes = processes;
    612e:	00003797          	auipc	a5,0x3
    6132:	3357ab23          	sw	s5,822(a5) # 9464 <num_processes>
    lock_ids = malloc(sizeof(int) * (num_processes - 1));
    6136:	0025151b          	slliw	a0,a0,0x2
    613a:	00000097          	auipc	ra,0x0
    613e:	ee2080e7          	jalr	-286(ra) # 601c <malloc>
    6142:	00003797          	auipc	a5,0x3
    6146:	30a7bb23          	sd	a0,790(a5) # 9458 <lock_ids>
    if (!lock_ids) {
    614a:	10050e63          	beqz	a0,6266 <tournament_create+0x166>
        return -1;  // Memory allocation failed
    }

    for (int i = 0; i < processes - 1; i++) {
    614e:	05605063          	blez	s6,618e <tournament_create+0x8e>
    6152:	4481                	li	s1,0
        lock_ids[i] = peterson_create();
    6154:	00003a17          	auipc	s4,0x3
    6158:	304a0a13          	addi	s4,s4,772 # 9458 <lock_ids>
    615c:	00048b9b          	sext.w	s7,s1
    6160:	00249913          	slli	s2,s1,0x2
    6164:	000a3983          	ld	s3,0(s4)
    6168:	99ca                	add	s3,s3,s2
    616a:	00000097          	auipc	ra,0x0
    616e:	afc080e7          	jalr	-1284(ra) # 5c66 <peterson_create>
    6172:	00a9a023          	sw	a0,0(s3)
        if (lock_ids[i] < 0) {
    6176:	000a3783          	ld	a5,0(s4)
    617a:	993e                	add	s2,s2,a5
    617c:	00092783          	lw	a5,0(s2)
    6180:	0607c163          	bltz	a5,61e2 <tournament_create+0xe2>
    for (int i = 0; i < processes - 1; i++) {
    6184:	0485                	addi	s1,s1,1
    6186:	0004879b          	sext.w	a5,s1
    618a:	fd67c9e3          	blt	a5,s6,615c <tournament_create+0x5c>
            return -1;
        }
    }
    ...
    num_levels = 0;
    618e:	00003797          	auipc	a5,0x3
    6192:	2c07a923          	sw	zero,722(a5) # 9460 <num_levels>
    int temp = num_processes;
    6196:	00003797          	auipc	a5,0x3
    619a:	2ce7a783          	lw	a5,718(a5) # 9464 <num_processes>
    while (temp > 1) {
    619e:	4705                	li	a4,1
    61a0:	00f75e63          	bge	a4,a5,61bc <tournament_create+0xbc>
    61a4:	4605                	li	a2,1
        temp >>= 1;
    61a6:	4017d79b          	sraiw	a5,a5,0x1
        num_levels++;
    61aa:	0007069b          	sext.w	a3,a4
    while (temp > 1) {
    61ae:	2705                	addiw	a4,a4,1
    61b0:	fef64be3          	blt	a2,a5,61a6 <tournament_create+0xa6>
    61b4:	00003797          	auipc	a5,0x3
    61b8:	2ad7a623          	sw	a3,684(a5) # 9460 <num_levels>
    }

    for (int i = 1; i < processes; i++) {
    61bc:	4785                	li	a5,1
    61be:	0157dd63          	bge	a5,s5,61d8 <tournament_create+0xd8>
    61c2:	4485                	li	s1,1
        int pid = fork();
    61c4:	00000097          	auipc	ra,0x0
    61c8:	9fa080e7          	jalr	-1542(ra) # 5bbe <fork>
        if (pid < 0) {
    61cc:	06054a63          	bltz	a0,6240 <tournament_create+0x140>
            printf("fork failed!\n");
            return -1;
        }
        if (pid == 0) {
    61d0:	c151                	beqz	a0,6254 <tournament_create+0x154>
    for (int i = 1; i < processes; i++) {
    61d2:	2485                	addiw	s1,s1,1
    61d4:	fe9a98e3          	bne	s5,s1,61c4 <tournament_create+0xc4>
            proc_id = i;
            return proc_id;
        }
    }
    ...
    return proc_id;
    61d8:	00003497          	auipc	s1,0x3
    61dc:	2904a483          	lw	s1,656(s1) # 9468 <proc_id>
    61e0:	a0a1                	j	6228 <tournament_create+0x128>
            for (int j = 0; j < i; j++) {
    61e2:	03705763          	blez	s7,6210 <tournament_create+0x110>
    61e6:	34fd                	addiw	s1,s1,-1
    61e8:	1482                	slli	s1,s1,0x20
    61ea:	9081                	srli	s1,s1,0x20
    61ec:	0485                	addi	s1,s1,1
    61ee:	048a                	slli	s1,s1,0x2
    61f0:	4901                	li	s2,0
                peterson_destroy(lock_ids[j]);
    61f2:	00003997          	auipc	s3,0x3
    61f6:	26698993          	addi	s3,s3,614 # 9458 <lock_ids>
    61fa:	0009b783          	ld	a5,0(s3)
    61fe:	97ca                	add	a5,a5,s2
    6200:	4388                	lw	a0,0(a5)
    6202:	00000097          	auipc	ra,0x0
    6206:	a7c080e7          	jalr	-1412(ra) # 5c7e <peterson_destroy>
            for (int j = 0; j < i; j++) {
    620a:	0911                	addi	s2,s2,4
    620c:	fe9917e3          	bne	s2,s1,61fa <tournament_create+0xfa>
            free(lock_ids);
    6210:	00003497          	auipc	s1,0x3
    6214:	24848493          	addi	s1,s1,584 # 9458 <lock_ids>
    6218:	6088                	ld	a0,0(s1)
    621a:	00000097          	auipc	ra,0x0
    621e:	d7a080e7          	jalr	-646(ra) # 5f94 <free>
            lock_ids = 0;
    6222:	0004b023          	sd	zero,0(s1)
            return -1;
    6226:	54fd                	li	s1,-1
}
    6228:	8526                	mv	a0,s1
    622a:	60a6                	ld	ra,72(sp)
    622c:	6406                	ld	s0,64(sp)
    622e:	74e2                	ld	s1,56(sp)
    6230:	7942                	ld	s2,48(sp)
    6232:	79a2                	ld	s3,40(sp)
    6234:	7a02                	ld	s4,32(sp)
    6236:	6ae2                	ld	s5,24(sp)
    6238:	6b42                	ld	s6,16(sp)
    623a:	6ba2                	ld	s7,8(sp)
    623c:	6161                	addi	sp,sp,80
    623e:	8082                	ret
            printf("fork failed!\n");
    6240:	00002517          	auipc	a0,0x2
    6244:	66850513          	addi	a0,a0,1640 # 88a8 <digits+0x18>
    6248:	00000097          	auipc	ra,0x0
    624c:	d16080e7          	jalr	-746(ra) # 5f5e <printf>
            return -1;
    6250:	54fd                	li	s1,-1
    6252:	bfd9                	j	6228 <tournament_create+0x128>
            proc_id = i;
    6254:	00003797          	auipc	a5,0x3
    6258:	2097aa23          	sw	s1,532(a5) # 9468 <proc_id>
            return proc_id;
    625c:	b7f1                	j	6228 <tournament_create+0x128>
        return -1;  // Not a power of 2 or out of range
    625e:	54fd                	li	s1,-1
    6260:	b7e1                	j	6228 <tournament_create+0x128>
    6262:	54fd                	li	s1,-1
    6264:	b7d1                	j	6228 <tournament_create+0x128>
        return -1;  // Memory allocation failed
    6266:	54fd                	li	s1,-1
    6268:	b7c1                	j	6228 <tournament_create+0x128>

000000000000626a <tournament_acquire>:

int tournament_acquire(void) {
    if (num_processes == 0 || num_levels == 0 || lock_ids == 0) {
    626a:	00003797          	auipc	a5,0x3
    626e:	1fa7a783          	lw	a5,506(a5) # 9464 <num_processes>
    6272:	10078163          	beqz	a5,6374 <tournament_acquire+0x10a>
int tournament_acquire(void) {
    6276:	7139                	addi	sp,sp,-64
    6278:	fc06                	sd	ra,56(sp)
    627a:	f822                	sd	s0,48(sp)
    627c:	f426                	sd	s1,40(sp)
    627e:	f04a                	sd	s2,32(sp)
    6280:	ec4e                	sd	s3,24(sp)
    6282:	e852                	sd	s4,16(sp)
    6284:	e456                	sd	s5,8(sp)
    6286:	0080                	addi	s0,sp,64
    if (num_processes == 0 || num_levels == 0 || lock_ids == 0) {
    6288:	00003497          	auipc	s1,0x3
    628c:	1d84a483          	lw	s1,472(s1) # 9460 <num_levels>
    6290:	c4e5                	beqz	s1,6378 <tournament_acquire+0x10e>
    6292:	00003797          	auipc	a5,0x3
    6296:	1c67b783          	ld	a5,454(a5) # 9458 <lock_ids>
    629a:	c3ed                	beqz	a5,637c <tournament_acquire+0x112>
        return -1;  // Tournament not initialized
    }

    int node = proc_id, role;
    for (int i = num_levels - 1; i >= 0; i--) {
    629c:	34fd                	addiw	s1,s1,-1
    629e:	0e04c163          	bltz	s1,6380 <tournament_acquire+0x116>
        // חישוב תפקיד (role) עבור הרמה הנוכחית
        int shift = num_levels - i - 1;
    62a2:	00003a17          	auipc	s4,0x3
    62a6:	1bea0a13          	addi	s4,s4,446 # 9460 <num_levels>
        role = (proc_id & (1 << shift)) >> shift;
    62aa:	00003997          	auipc	s3,0x3
    62ae:	1be98993          	addi	s3,s3,446 # 9468 <proc_id>
    62b2:	4905                	li	s2,1
    for (int i = num_levels - 1; i >= 0; i--) {
    62b4:	5afd                	li	s5,-1
        int shift = num_levels - i - 1;
    62b6:	000a2783          	lw	a5,0(s4)
    62ba:	4097873b          	subw	a4,a5,s1
    62be:	fff7059b          	addiw	a1,a4,-1
        role = (proc_id & (1 << shift)) >> shift;
    62c2:	0009a783          	lw	a5,0(s3)
    62c6:	00b916bb          	sllw	a3,s2,a1
    62ca:	8efd                	and	a3,a3,a5

        // חישוב אינדקס של המנעול ברמה זו
        int lock_level_idx = proc_id >> (num_levels - i);
        node = lock_level_idx + (1 << i) - 1;
    62cc:	0099153b          	sllw	a0,s2,s1
        int lock_level_idx = proc_id >> (num_levels - i);
    62d0:	40e7d7bb          	sraw	a5,a5,a4
        node = lock_level_idx + (1 << i) - 1;
    62d4:	9d3d                	addw	a0,a0,a5

        if (peterson_acquire(node, role) < 0) {
    62d6:	40b6d5bb          	sraw	a1,a3,a1
    62da:	357d                	addiw	a0,a0,-1
    62dc:	00000097          	auipc	ra,0x0
    62e0:	992080e7          	jalr	-1646(ra) # 5c6e <peterson_acquire>
    62e4:	00054f63          	bltz	a0,6302 <tournament_acquire+0x98>
    for (int i = num_levels - 1; i >= 0; i--) {
    62e8:	34fd                	addiw	s1,s1,-1
    62ea:	fd5496e3          	bne	s1,s5,62b6 <tournament_acquire+0x4c>
            }
            return -1;
        }
    }
    ...
    62f0:	70e2                	ld	ra,56(sp)
    62f2:	7442                	ld	s0,48(sp)
    62f4:	74a2                	ld	s1,40(sp)
    62f6:	7902                	ld	s2,32(sp)
    62f8:	69e2                	ld	s3,24(sp)
    62fa:	6a42                	ld	s4,16(sp)
    62fc:	6aa2                	ld	s5,8(sp)
    62fe:	6121                	addi	sp,sp,64
    6300:	8082                	ret
            printf("failed to acquire: %d \n", proc_id);
    6302:	00003597          	auipc	a1,0x3
    6306:	1665a583          	lw	a1,358(a1) # 9468 <proc_id>
    630a:	00002517          	auipc	a0,0x2
    630e:	5ae50513          	addi	a0,a0,1454 # 88b8 <digits+0x28>
    6312:	00000097          	auipc	ra,0x0
    6316:	c4c080e7          	jalr	-948(ra) # 5f5e <printf>
            for (int j = i; j < num_levels; j++) {
    631a:	00003517          	auipc	a0,0x3
    631e:	14652503          	lw	a0,326(a0) # 9460 <num_levels>
    6322:	06a4d163          	bge	s1,a0,6384 <tournament_acquire+0x11a>
                int r = (proc_id & (1 << shift2)) >> shift2;
    6326:	00003997          	auipc	s3,0x3
    632a:	14298993          	addi	s3,s3,322 # 9468 <proc_id>
    632e:	4905                	li	s2,1
            for (int j = i; j < num_levels; j++) {
    6330:	00003a17          	auipc	s4,0x3
    6334:	130a0a13          	addi	s4,s4,304 # 9460 <num_levels>
                int shift2 = num_levels - j - 1;
    6338:	409507bb          	subw	a5,a0,s1
    633c:	fff7859b          	addiw	a1,a5,-1
                int r = (proc_id & (1 << shift2)) >> shift2;
    6340:	0009a503          	lw	a0,0(s3)
    6344:	00b9173b          	sllw	a4,s2,a1
    6348:	8f69                	and	a4,a4,a0
                int li = (proc_id >> (num_levels - j)) + (1 << j) - 1;
    634a:	40f5553b          	sraw	a0,a0,a5
    634e:	009917bb          	sllw	a5,s2,s1
    6352:	9d3d                	addw	a0,a0,a5
                if (peterson_release(li, r) < 0) {
    6354:	40b755bb          	sraw	a1,a4,a1
    6358:	357d                	addiw	a0,a0,-1
    635a:	00000097          	auipc	ra,0x0
    635e:	91c080e7          	jalr	-1764(ra) # 5c76 <peterson_release>
    6362:	02054363          	bltz	a0,6388 <tournament_acquire+0x11e>
            for (int j = i; j < num_levels; j++) {
    6366:	2485                	addiw	s1,s1,1
    6368:	000a2503          	lw	a0,0(s4)
    636c:	fca4c6e3          	blt	s1,a0,6338 <tournament_acquire+0xce>
            return -1;
    6370:	557d                	li	a0,-1
    6372:	bfbd                	j	62f0 <tournament_acquire+0x86>
        return -1;  // Tournament not initialized
    6374:	557d                	li	a0,-1
}
    6376:	8082                	ret
        return -1;  // Tournament not initialized
    6378:	557d                	li	a0,-1
    637a:	bf9d                	j	62f0 <tournament_acquire+0x86>
    637c:	557d                	li	a0,-1
    637e:	bf8d                	j	62f0 <tournament_acquire+0x86>
    return 0;
    6380:	4501                	li	a0,0
    6382:	b7bd                	j	62f0 <tournament_acquire+0x86>
            return -1;
    6384:	557d                	li	a0,-1
    6386:	b7ad                	j	62f0 <tournament_acquire+0x86>
                    return -1;
    6388:	557d                	li	a0,-1
    638a:	b79d                	j	62f0 <tournament_acquire+0x86>

000000000000638c <tournament_release>:

int tournament_release(void) {
    int node = proc_id, role;
    for (int i = 0; i < num_levels; i++) {
    638c:	00003517          	auipc	a0,0x3
    6390:	0d452503          	lw	a0,212(a0) # 9460 <num_levels>
    6394:	06a05263          	blez	a0,63f8 <tournament_release+0x6c>
int tournament_release(void) {
    6398:	7179                	addi	sp,sp,-48
    639a:	f406                	sd	ra,40(sp)
    639c:	f022                	sd	s0,32(sp)
    639e:	ec26                	sd	s1,24(sp)
    63a0:	e84a                	sd	s2,16(sp)
    63a2:	e44e                	sd	s3,8(sp)
    63a4:	e052                	sd	s4,0(sp)
    63a6:	1800                	addi	s0,sp,48
    for (int i = 0; i < num_levels; i++) {
    63a8:	4481                	li	s1,0
        // חישוב תפקיד (role)
        int shift = num_levels - i - 1;
        role = (proc_id & (1 << shift)) >> shift;
    63aa:	00003997          	auipc	s3,0x3
    63ae:	0be98993          	addi	s3,s3,190 # 9468 <proc_id>
    63b2:	4905                	li	s2,1
    for (int i = 0; i < num_levels; i++) {
    63b4:	00003a17          	auipc	s4,0x3
    63b8:	0aca0a13          	addi	s4,s4,172 # 9460 <num_levels>
        int shift = num_levels - i - 1;
    63bc:	9d05                	subw	a0,a0,s1
    63be:	fff5059b          	addiw	a1,a0,-1
        role = (proc_id & (1 << shift)) >> shift;
    63c2:	0009a703          	lw	a4,0(s3)
    63c6:	00b916bb          	sllw	a3,s2,a1
    63ca:	8ef9                	and	a3,a3,a4

        // חישוב אינדקס של המנעול
        int lock_level_idx = proc_id >> (num_levels - i);
        node = lock_level_idx + (1 << i) - 1;
    63cc:	009917bb          	sllw	a5,s2,s1
        int lock_level_idx = proc_id >> (num_levels - i);
    63d0:	40a7573b          	sraw	a4,a4,a0
        node = lock_level_idx + (1 << i) - 1;
    63d4:	00e7853b          	addw	a0,a5,a4

        if (peterson_release(node, role) < 0) {
    63d8:	40b6d5bb          	sraw	a1,a3,a1
    63dc:	357d                	addiw	a0,a0,-1
    63de:	00000097          	auipc	ra,0x0
    63e2:	898080e7          	jalr	-1896(ra) # 5c76 <peterson_release>
    63e6:	00054b63          	bltz	a0,63fc <tournament_release+0x70>
    for (int i = 0; i < num_levels; i++) {
    63ea:	2485                	addiw	s1,s1,1
    63ec:	000a2503          	lw	a0,0(s4)
    63f0:	fca4c6e3          	blt	s1,a0,63bc <tournament_release+0x30>
            return -1;
        }
    }
    return 0;
    63f4:	4501                	li	a0,0
    63f6:	a021                	j	63fe <tournament_release+0x72>
    63f8:	4501                	li	a0,0
}
    63fa:	8082                	ret
            return -1;
    ...
    63fe:	70a2                	ld	ra,40(sp)
    6400:	7402                	ld	s0,32(sp)
    6402:	64e2                	ld	s1,24(sp)
    6404:	6942                	ld	s2,16(sp)
    6406:	69a2                	ld	s3,8(sp)
    6408:	6a02                	ld	s4,0(sp)
    640a:	6145                	addi	sp,sp,48
    640c:	8082                	ret

...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	61e58593          	addi	a1,a1,1566 # 1630 <tournament_release+0x8c>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	5d858593          	addi	a1,a1,1496 # 1638 <tournament_release+0x94>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	5a650513          	addi	a0,a0,1446 # 1640 <tournament_release+0x9c>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	67a70713          	addi	a4,a4,1658 # 1740 <tournament_release+0x19c>
    ...
    panic("runcmd");
      ...
      e4:	56850513          	addi	a0,a0,1384 # 1648 <tournament_release+0xa4>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	54e58593          	addi	a1,a1,1358 # 1650 <tournament_release+0xac>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	51258593          	addi	a1,a1,1298 # 1660 <tournament_release+0xbc>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	48c50513          	addi	a0,a0,1164 # 1670 <tournament_release+0xcc>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a8:	0f4b8b93          	addi	s7,s7,244 # 1698 <tournament_release+0xf4>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	0c250513          	addi	a0,a0,194 # 1678 <tournament_release+0xd4>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a2:	00260613          	addi	a2,a2,2 # 16a0 <tournament_release+0xfc>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d2:	ff2b0b13          	addi	s6,s6,-14 # 16c0 <tournament_release+0x11c>
  ...
  return ret;
     ...
     70c:	fa050513          	addi	a0,a0,-96 # 16a8 <tournament_release+0x104>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76e:	f4650513          	addi	a0,a0,-186 # 16b0 <tournament_release+0x10c>
...
0000000000000788 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a8:	f2460613          	addi	a2,a2,-220 # 16c8 <tournament_release+0x124>
     7ac:	85ce                	mv	a1,s3
     7ae:	854a                	mv	a0,s2
...
00000000000007f6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     818:	ebca0a13          	addi	s4,s4,-324 # 16d0 <tournament_release+0x12c>
  ...
  if(peek(ps, es, ";")){
     ...
     84e:	e8e60613          	addi	a2,a2,-370 # 16d8 <tournament_release+0x134>
     852:	85ce                	mv	a1,s3
     854:	854a                	mv	a0,s2
...
000000000000089e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b4:	df060613          	addi	a2,a2,-528 # 16a0 <tournament_release+0xfc>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e4:	e1060613          	addi	a2,a2,-496 # 16f0 <tournament_release+0x14c>
     8e8:	85ca                	mv	a1,s2
     8ea:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     926:	dbe50513          	addi	a0,a0,-578 # 16e0 <tournament_release+0x13c>
     92a:	fffff097          	auipc	ra,0xfffff
     92e:	72c080e7          	jalr	1836(ra) # 56 <panic>
    panic("syntax - missing )");
     932:	00001517          	auipc	a0,0x1
     936:	dc650513          	addi	a0,a0,-570 # 16f8 <tournament_release+0x154>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     962:	dfa70713          	addi	a4,a4,-518 # 1758 <tournament_release+0x1b4>
...
00000000000009da <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0e:	d0660613          	addi	a2,a2,-762 # 1710 <tournament_release+0x16c>
     a12:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a44:	cd858593          	addi	a1,a1,-808 # 1718 <tournament_release+0x174>
     a48:	4509                	li	a0,2
     a4a:	00000097          	auipc	ra,0x0
     a4e:	6fe080e7          	jalr	1790(ra) # 1148 <fprintf>
    panic("syntax");
     a52:	00001517          	auipc	a0,0x1
     a56:	c5650513          	addi	a0,a0,-938 # 16a8 <tournament_release+0x104>
...
0000000000000a62 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a78:	cb448493          	addi	s1,s1,-844 # 1728 <tournament_release+0x184>
     a7c:	4589                	li	a1,2
     a7e:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     ab6:	c7ea8a93          	addi	s5,s5,-898 # 1730 <tournament_release+0x18c>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ee6:	89650513          	addi	a0,a0,-1898 # 1778 <digits>
     eea:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     fb2:	7cab8b93          	addi	s7,s7,1994 # 1778 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10f2:	68290913          	addi	s2,s2,1666 # 1770 <tournament_release+0x1cc>
        while(*s != 0){
...
malloc(uint nbytes)
{
  ...
  if(p == (char*)-1)
    ...
    1290:	e0c78793          	addi	a5,a5,-500 # 2098 <base>
...
0000000000001318 <tournament_create>:
...
int tournament_create(int processes) {
    1318:	715d                	addi	sp,sp,-80
    131a:	e486                	sd	ra,72(sp)
    131c:	e0a2                	sd	s0,64(sp)
    131e:	fc26                	sd	s1,56(sp)
    1320:	f84a                	sd	s2,48(sp)
    1322:	f44e                	sd	s3,40(sp)
    1324:	f052                	sd	s4,32(sp)
    1326:	ec56                	sd	s5,24(sp)
    1328:	e85a                	sd	s6,16(sp)
    132a:	e45e                	sd	s7,8(sp)
    132c:	0880                	addi	s0,sp,80
    // Check if the number of processes is valid (power of 2 up to 16)
    if (processes <= 0 || processes > 16 || (processes & (processes - 1)) != 0) {
    132e:	fff5071b          	addiw	a4,a0,-1
    1332:	47bd                	li	a5,15
    1334:	14e7e163          	bltu	a5,a4,1476 <tournament_create+0x15e>
    1338:	8aaa                	mv	s5,a0
    133a:	357d                	addiw	a0,a0,-1
    133c:	8b3a                	mv	s6,a4
    133e:	015777b3          	and	a5,a4,s5
    1342:	12079c63          	bnez	a5,147a <tournament_create+0x162>
        return -1;  // Not a power of 2 or out of range
    }

    num_processes = processes;
    1346:	00001797          	auipc	a5,0x1
    134a:	cd57af23          	sw	s5,-802(a5) # 2024 <num_processes>
    lock_ids = malloc(sizeof(int) * (num_processes - 1));
    134e:	0025151b          	slliw	a0,a0,0x2
    1352:	00000097          	auipc	ra,0x0
    1356:	ee2080e7          	jalr	-286(ra) # 1234 <malloc>
    135a:	00001797          	auipc	a5,0x1
    135e:	caa7bf23          	sd	a0,-834(a5) # 2018 <lock_ids>
    if (!lock_ids) {
    1362:	10050e63          	beqz	a0,147e <tournament_create+0x166>
        return -1;  // Memory allocation failed
    }

    for (int i = 0; i < processes - 1; i++) {
    1366:	05605063          	blez	s6,13a6 <tournament_create+0x8e>
    136a:	4481                	li	s1,0
        lock_ids[i] = peterson_create();
    136c:	00001a17          	auipc	s4,0x1
    1370:	caca0a13          	addi	s4,s4,-852 # 2018 <lock_ids>
    1374:	00048b9b          	sext.w	s7,s1
    1378:	00249913          	slli	s2,s1,0x2
    137c:	000a3983          	ld	s3,0(s4)
    1380:	99ca                	add	s3,s3,s2
    1382:	00000097          	auipc	ra,0x0
    1386:	afc080e7          	jalr	-1284(ra) # e7e <peterson_create>
    138a:	00a9a023          	sw	a0,0(s3)
        if (lock_ids[i] < 0) {
    138e:	000a3783          	ld	a5,0(s4)
    1392:	993e                	add	s2,s2,a5
    1394:	00092783          	lw	a5,0(s2)
    1398:	0607c163          	bltz	a5,13fa <tournament_create+0xe2>
    for (int i = 0; i < processes - 1; i++) {
    139c:	0485                	addi	s1,s1,1
    139e:	0004879b          	sext.w	a5,s1
    13a2:	fd67c9e3          	blt	a5,s6,1374 <tournament_create+0x5c>
            return -1;
        }
    }
    ...
    13aa:	c607ad23          	sw	zero,-902(a5) # 2020 <num_levels>
    int temp = num_processes;
    13ae:	00001797          	auipc	a5,0x1
    13b2:	c767a783          	lw	a5,-906(a5) # 2024 <num_processes>
    while (temp > 1) {
    13b6:	4705                	li	a4,1
    13b8:	00f75e63          	bge	a4,a5,13d4 <tournament_create+0xbc>
    13bc:	4605                	li	a2,1
        temp >>= 1;
    13be:	4017d79b          	sraiw	a5,a5,0x1
        num_levels++;
    13c2:	0007069b          	sext.w	a3,a4
    while (temp > 1) {
    13c6:	2705                	addiw	a4,a4,1
    13c8:	fef64be3          	blt	a2,a5,13be <tournament_create+0xa6>
    13cc:	00001797          	auipc	a5,0x1
    13d0:	c4d7aa23          	sw	a3,-940(a5) # 2020 <num_levels>
    }

    for (int i = 1; i < processes; i++) {
    13d4:	4785                	li	a5,1
    13d6:	0157dd63          	bge	a5,s5,13f0 <tournament_create+0xd8>
    13da:	4485                	li	s1,1
        int pid = fork();
    13dc:	00000097          	auipc	ra,0x0
    13e0:	9fa080e7          	jalr	-1542(ra) # dd6 <fork>
        if (pid < 0) {
    13e4:	06054a63          	bltz	a0,1458 <tournament_create+0x140>
            printf("fork failed!\n");
            return -1;
        }
        if (pid == 0) {
    13e8:	c151                	beqz	a0,146c <tournament_create+0x154>
    for (int i = 1; i < processes; i++) {
    13ea:	2485                	addiw	s1,s1,1
    13ec:	fe9a98e3          	bne	s5,s1,13dc <tournament_create+0xc4>
            proc_id = i;
            return proc_id;
        }
    }
    ...
    return proc_id;
    13f0:	00001497          	auipc	s1,0x1
    13f4:	c384a483          	lw	s1,-968(s1) # 2028 <proc_id>
    13f8:	a0a1                	j	1440 <tournament_create+0x128>
            for (int j = 0; j < i; j++) {
    13fa:	03705763          	blez	s7,1428 <tournament_create+0x110>
    13fe:	34fd                	addiw	s1,s1,-1
    1400:	1482                	slli	s1,s1,0x20
    1402:	9081                	srli	s1,s1,0x20
    1404:	0485                	addi	s1,s1,1
    1406:	048a                	slli	s1,s1,0x2
    1408:	4901                	li	s2,0
                peterson_destroy(lock_ids[j]);
    140a:	00001997          	auipc	s3,0x1
    140e:	c0e98993          	addi	s3,s3,-1010 # 2018 <lock_ids>
    1412:	0009b783          	ld	a5,0(s3)
    1416:	97ca                	add	a5,a5,s2
    1418:	4388                	lw	a0,0(a5)
    141a:	00000097          	auipc	ra,0x0
    141e:	a7c080e7          	jalr	-1412(ra) # e96 <peterson_destroy>
            for (int j = 0; j < i; j++) {
    1422:	0911                	addi	s2,s2,4
    1424:	fe9917e3          	bne	s2,s1,1412 <tournament_create+0xfa>
            free(lock_ids);
    1428:	00001497          	auipc	s1,0x1
    142c:	bf048493          	addi	s1,s1,-1040 # 2018 <lock_ids>
    1430:	6088                	ld	a0,0(s1)
    1432:	00000097          	auipc	ra,0x0
    1436:	d7a080e7          	jalr	-646(ra) # 11ac <free>
            lock_ids = 0;
    143a:	0004b023          	sd	zero,0(s1)
            return -1;
    143e:	54fd                	li	s1,-1
}
    1440:	8526                	mv	a0,s1
    1442:	60a6                	ld	ra,72(sp)
    1444:	6406                	ld	s0,64(sp)
    1446:	74e2                	ld	s1,56(sp)
    1448:	7942                	ld	s2,48(sp)
    144a:	79a2                	ld	s3,40(sp)
    144c:	7a02                	ld	s4,32(sp)
    144e:	6ae2                	ld	s5,24(sp)
    1450:	6b42                	ld	s6,16(sp)
    1452:	6ba2                	ld	s7,8(sp)
    1454:	6161                	addi	sp,sp,80
    1456:	8082                	ret
            printf("fork failed!\n");
    1458:	00000517          	auipc	a0,0x0
    145c:	33850513          	addi	a0,a0,824 # 1790 <digits+0x18>
    1460:	00000097          	auipc	ra,0x0
    1464:	d16080e7          	jalr	-746(ra) # 1176 <printf>
            return -1;
    1468:	54fd                	li	s1,-1
    146a:	bfd9                	j	1440 <tournament_create+0x128>
            proc_id = i;
    146c:	00001797          	auipc	a5,0x1
    1470:	ba97ae23          	sw	s1,-1092(a5) # 2028 <proc_id>
            return proc_id;
    1474:	b7f1                	j	1440 <tournament_create+0x128>
        return -1;  // Not a power of 2 or out of range
    1476:	54fd                	li	s1,-1
    1478:	b7e1                	j	1440 <tournament_create+0x128>
    147a:	54fd                	li	s1,-1
    147c:	b7d1                	j	1440 <tournament_create+0x128>
        return -1;  // Memory allocation failed
    147e:	54fd                	li	s1,-1
    1480:	b7c1                	j	1440 <tournament_create+0x128>

0000000000001482 <tournament_acquire>:

int tournament_acquire(void) {
    if (num_processes == 0 || num_levels == 0 || lock_ids == 0) {
    1482:	00001797          	auipc	a5,0x1
    1486:	ba27a783          	lw	a5,-1118(a5) # 2024 <num_processes>
    148a:	10078163          	beqz	a5,158c <tournament_acquire+0x10a>
int tournament_acquire(void) {
    ...
    149e:	0080                	addi	s0,sp,64
    if (num_processes == 0 || num_levels == 0 || lock_ids == 0) {
    14a0:	00001497          	auipc	s1,0x1
    14a4:	b804a483          	lw	s1,-1152(s1) # 2020 <num_levels>
    14a8:	c4e5                	beqz	s1,1590 <tournament_acquire+0x10e>
    14aa:	00001797          	auipc	a5,0x1
    14ae:	b6e7b783          	ld	a5,-1170(a5) # 2018 <lock_ids>
    14b2:	c3ed                	beqz	a5,1594 <tournament_acquire+0x112>
    ...
    14b6:	0e04c163          	bltz	s1,1598 <tournament_acquire+0x116>
        // חישוב תפקיד (role) עבור הרמה הנוכחית
        int shift = num_levels - i - 1;
    14ba:	00001a17          	auipc	s4,0x1
    14be:	b66a0a13          	addi	s4,s4,-1178 # 2020 <num_levels>
        role = (proc_id & (1 << shift)) >> shift;
    14c2:	00001997          	auipc	s3,0x1
    14c6:	b6698993          	addi	s3,s3,-1178 # 2028 <proc_id>
    14ca:	4905                	li	s2,1
    for (int i = num_levels - 1; i >= 0; i--) {
    14cc:	5afd                	li	s5,-1
        int shift = num_levels - i - 1;
    14ce:	000a2783          	lw	a5,0(s4)
    14d2:	4097873b          	subw	a4,a5,s1
    14d6:	fff7059b          	addiw	a1,a4,-1
        role = (proc_id & (1 << shift)) >> shift;
    14da:	0009a783          	lw	a5,0(s3)
    14de:	00b916bb          	sllw	a3,s2,a1
    14e2:	8efd                	and	a3,a3,a5

        // חישוב אינדקס של המנעול ברמה זו
        int lock_level_idx = proc_id >> (num_levels - i);
        node = lock_level_idx + (1 << i) - 1;
    14e4:	0099153b          	sllw	a0,s2,s1
        int lock_level_idx = proc_id >> (num_levels - i);
    14e8:	40e7d7bb          	sraw	a5,a5,a4
        node = lock_level_idx + (1 << i) - 1;
    14ec:	9d3d                	addw	a0,a0,a5

        if (peterson_acquire(node, role) < 0) {
    14ee:	40b6d5bb          	sraw	a1,a3,a1
    14f2:	357d                	addiw	a0,a0,-1
    14f4:	00000097          	auipc	ra,0x0
    14f8:	992080e7          	jalr	-1646(ra) # e86 <peterson_acquire>
    14fc:	00054f63          	bltz	a0,151a <tournament_acquire+0x98>
    for (int i = num_levels - 1; i >= 0; i--) {
    1500:	34fd                	addiw	s1,s1,-1
    1502:	fd5496e3          	bne	s1,s5,14ce <tournament_acquire+0x4c>
            }
            return -1;
        }
    }
    ...
    150c:	74a2                	ld	s1,40(sp)
    150e:	7902                	ld	s2,32(sp)
    1510:	69e2                	ld	s3,24(sp)
    1512:	6a42                	ld	s4,16(sp)
    1514:	6aa2                	ld	s5,8(sp)
    1516:	6121                	addi	sp,sp,64
    1518:	8082                	ret
            printf("failed to acquire: %d \n", proc_id);
    151a:	00001597          	auipc	a1,0x1
    151e:	b0e5a583          	lw	a1,-1266(a1) # 2028 <proc_id>
    1522:	00000517          	auipc	a0,0x0
    1526:	27e50513          	addi	a0,a0,638 # 17a0 <digits+0x28>
    152a:	00000097          	auipc	ra,0x0
    152e:	c4c080e7          	jalr	-948(ra) # 1176 <printf>
            for (int j = i; j < num_levels; j++) {
    1532:	00001517          	auipc	a0,0x1
    1536:	aee52503          	lw	a0,-1298(a0) # 2020 <num_levels>
    153a:	06a4d163          	bge	s1,a0,159c <tournament_acquire+0x11a>
                int r = (proc_id & (1 << shift2)) >> shift2;
    153e:	00001997          	auipc	s3,0x1
    1542:	aea98993          	addi	s3,s3,-1302 # 2028 <proc_id>
    1546:	4905                	li	s2,1
            for (int j = i; j < num_levels; j++) {
    1548:	00001a17          	auipc	s4,0x1
    154c:	ad8a0a13          	addi	s4,s4,-1320 # 2020 <num_levels>
                int shift2 = num_levels - j - 1;
    1550:	409507bb          	subw	a5,a0,s1
    1554:	fff7859b          	addiw	a1,a5,-1
                int r = (proc_id & (1 << shift2)) >> shift2;
    1558:	0009a503          	lw	a0,0(s3)
    155c:	00b9173b          	sllw	a4,s2,a1
    1560:	8f69                	and	a4,a4,a0
                int li = (proc_id >> (num_levels - j)) + (1 << j) - 1;
    1562:	40f5553b          	sraw	a0,a0,a5
    1566:	009917bb          	sllw	a5,s2,s1
    156a:	9d3d                	addw	a0,a0,a5
                if (peterson_release(li, r) < 0) {
    156c:	40b755bb          	sraw	a1,a4,a1
    1570:	357d                	addiw	a0,a0,-1
    1572:	00000097          	auipc	ra,0x0
    1576:	91c080e7          	jalr	-1764(ra) # e8e <peterson_release>
    157a:	02054363          	bltz	a0,15a0 <tournament_acquire+0x11e>
            for (int j = i; j < num_levels; j++) {
    157e:	2485                	addiw	s1,s1,1
    1580:	000a2503          	lw	a0,0(s4)
    1584:	fca4c6e3          	blt	s1,a0,1550 <tournament_acquire+0xce>
            return -1;
    1588:	557d                	li	a0,-1
    158a:	bfbd                	j	1508 <tournament_acquire+0x86>
        return -1;  // Tournament not initialized
    158c:	557d                	li	a0,-1
}
    158e:	8082                	ret
        return -1;  // Tournament not initialized
    1590:	557d                	li	a0,-1
    1592:	bf9d                	j	1508 <tournament_acquire+0x86>
    1594:	557d                	li	a0,-1
    1596:	bf8d                	j	1508 <tournament_acquire+0x86>
    return 0;
    1598:	4501                	li	a0,0
    159a:	b7bd                	j	1508 <tournament_acquire+0x86>
            return -1;
    159c:	557d                	li	a0,-1
    159e:	b7ad                	j	1508 <tournament_acquire+0x86>
                    return -1;
    15a0:	557d                	li	a0,-1
    15a2:	b79d                	j	1508 <tournament_acquire+0x86>

00000000000015a4 <tournament_release>:

int tournament_release(void) {
    int node = proc_id, role;
    for (int i = 0; i < num_levels; i++) {
    15a4:	00001517          	auipc	a0,0x1
    15a8:	a7c52503          	lw	a0,-1412(a0) # 2020 <num_levels>
    15ac:	06a05263          	blez	a0,1610 <tournament_release+0x6c>
int tournament_release(void) {
    15b0:	7179                	addi	sp,sp,-48
    15b2:	f406                	sd	ra,40(sp)
    15b4:	f022                	sd	s0,32(sp)
    15b6:	ec26                	sd	s1,24(sp)
    15b8:	e84a                	sd	s2,16(sp)
    15ba:	e44e                	sd	s3,8(sp)
    15bc:	e052                	sd	s4,0(sp)
    15be:	1800                	addi	s0,sp,48
    for (int i = 0; i < num_levels; i++) {
    15c0:	4481                	li	s1,0
        // חישוב תפקיד (role)
        int shift = num_levels - i - 1;
        role = (proc_id & (1 << shift)) >> shift;
    15c2:	00001997          	auipc	s3,0x1
    15c6:	a6698993          	addi	s3,s3,-1434 # 2028 <proc_id>
    15ca:	4905                	li	s2,1
    for (int i = 0; i < num_levels; i++) {
    15cc:	00001a17          	auipc	s4,0x1
    15d0:	a54a0a13          	addi	s4,s4,-1452 # 2020 <num_levels>
        int shift = num_levels - i - 1;
    15d4:	9d05                	subw	a0,a0,s1
    15d6:	fff5059b          	addiw	a1,a0,-1
        role = (proc_id & (1 << shift)) >> shift;
    15da:	0009a703          	lw	a4,0(s3)
    15de:	00b916bb          	sllw	a3,s2,a1
    15e2:	8ef9                	and	a3,a3,a4

        // חישוב אינדקס של המנעול
        int lock_level_idx = proc_id >> (num_levels - i);
        node = lock_level_idx + (1 << i) - 1;
    15e4:	009917bb          	sllw	a5,s2,s1
        int lock_level_idx = proc_id >> (num_levels - i);
    15e8:	40a7573b          	sraw	a4,a4,a0
        node = lock_level_idx + (1 << i) - 1;
    15ec:	00e7853b          	addw	a0,a5,a4

        if (peterson_release(node, role) < 0) {
    15f0:	40b6d5bb          	sraw	a1,a3,a1
    15f4:	357d                	addiw	a0,a0,-1
    15f6:	00000097          	auipc	ra,0x0
    15fa:	898080e7          	jalr	-1896(ra) # e8e <peterson_release>
    15fe:	00054b63          	bltz	a0,1614 <tournament_release+0x70>
    for (int i = 0; i < num_levels; i++) {
    1602:	2485                	addiw	s1,s1,1
    1604:	000a2503          	lw	a0,0(s4)
    1608:	fca4c6e3          	blt	s1,a0,15d4 <tournament_release+0x30>
            return -1;
        }
    }
    return 0;
    160c:	4501                	li	a0,0
    160e:	a021                	j	1616 <tournament_release+0x72>
    1610:	4501                	li	a0,0
}
    1612:	8082                	ret
            return -1;
    ...
    1616:	70a2                	ld	ra,40(sp)
    1618:	7402                	ld	s0,32(sp)
    161a:	64e2                	ld	s1,24(sp)
    161c:	6942                	ld	s2,16(sp)
    161e:	69a2                	ld	s3,8(sp)
    1620:	6a02                	ld	s4,0(sp)
    1622:	6145                	addi	sp,sp,48
    1624:	8082                	ret
